angular
  .module("umbraco")
  .controller(
    "OsmMaps.PropertyEditorController",
    function (
      $rootScope,
      $scope,
      ...
      var place,
        ...
        defaultLat = $scope.model.config
          ? 55.406191899999996
          : $scope.model.config.lat,
        defaultLng = $scope.model.config
          ? 10.388192199999999
          : $scope.model.config.lng;
      defaultZoomLvl = parseInt(
        $scope.model.config ? 30 : $scope.model.config.zoomlevel
      );
      ...
      assetsService
        .loadJs("/app_plugins/OsmMaps/assets/leaflet/leaflet.js")
        .then(function () {
          $timeout(function () {
            initializeMap();
          });
      ...
      function initializeMap() {
        ...
        resetBtn = document.getElementById(
          "umb-osmmaps-reset-" + $scope.model.uid
        );
        ...
        self.map.on("click", function (e) {
          var center = e.latlng;
          $scope.model.value =
            e.latlng.lat + "," + e.latlng.lng + "," + self.map.getZoom();

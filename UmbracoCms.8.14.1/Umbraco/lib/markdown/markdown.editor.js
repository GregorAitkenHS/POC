...
(function () {
  ...
  var imageDialogText =
    '<p>http://example.com/images/diagram.jpg "optional title"</p>';
  ...
  ui.prompt = function (title, text, defaultInputText, callback) {
    ...
    var createDialog = function () {
      ...
      header.innerHTML =
        '<a class="close" data-dismiss="modal">×</a> <h3>' + title + "</h3>";
  ...
  function UIManager(
    ...
    function doClick(button) {
      ...
      if (
        document.activeElement !== panels.input &&
        !panels.buttonBar.contains(document.activeElement)
      ) {
        return;
      }

  ...
  function spectrum(element, o) {
    ...
    function initialize() {
      ...
      if (shouldReplace) {
        ...
        boundElement
          .addClass("spectrum sp-colorize")
          .wrap(originalInputContainer);
      ...
      colorizeElementInitialBackground =
        colorizeElement.css("background-color");
      ...
      if (!!initialColor) {
        ...
        currentPreferredFormat =
          tinycolor(initialColor).format || opts.preferredFormat;
    ...
    function updateUI() {
      ...
      if (opts.type == "text" || opts.type == "component") {
        ...
        if (color && colorizeElement) {
          var textColor =
            color.isLight() || color.getAlpha() < 0.4 ? "black" : "white";
          colorizeElement
            .css("background-color", color.toRgbString())
            .css("color", textColor);
        } else {
          colorizeElement
            .css("background-color", colorizeElementInitialBackground)
    ...
    function destroy() {
      ...
      var originalInputContainer = boundElement.closest(

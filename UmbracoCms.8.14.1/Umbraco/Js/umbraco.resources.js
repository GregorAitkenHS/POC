(function () {
  ...
  function authResource($q, $http, umbRequestHelper, angularHelper) {
    return {
      ...
      performLogin: function performLogin(username, password) {
        ...
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("authenticationApiBaseUrl", "PostLogin"),
            {
              username: username,
              password: password,
            }
       ...
       *
       */
      performValidatePasswordResetCode:
        function performValidatePasswordResetCode(userId, resetCode) {
          if (!userId) {
          ...
          return umbRequestHelper.resourcePromise(
            ...
            "Password reset code validation failed for userId " +
              userId +
              ", code" +
              resetCode
          );
       ...
       *
       */
      performSetPassword: function performSetPassword(
        userId,
        password,
        confirmPassword,
        resetCode
      ...
      performLogout: function performLogout() {
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("authenticationApiBaseUrl", "PostLogout")
          )
        );
      },
      /**
  ...
  function codefileResource(
    ...
    return {
      ...
      getByPath: function getByPath(type, virtualpath) {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("codeFileApiBaseUrl", "GetByPath", [
              { type: type },
      ...
      getByAlias: function getByAlias(alias) {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("templateApiBaseUrl", "GetByAlias", [
              { alias: alias },
            ])
          ),
      ...
      deleteByPath: function deleteByPath(type, virtualpath) {
        var promise = localizationService.localize(
          "codefile_deleteItemFailed",
          [virtualpath]
        );
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("codeFileApiBaseUrl", "Delete", [
              { type: type },
              { virtualPath: virtualpath },
            ])
          ),
      ...
      save: function save(codeFile) {
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("codeFileApiBaseUrl", "PostSave"),
            codeFile
          ),
      ...
      createContainer: function createContainer(type, parentId, name) {
        ...
        var key =
          "codefile_createFolderFailedBy" +
          (isNaN(parseInt(parentId)) ? "Name" : "Id");
       ...
       *
       */
      interpolateStylesheetRules: function interpolateStylesheetRules(
        content,
        rules
      ) {
        var payload = {
  ...
  angular
    ...
    .factory("codefileResource", codefileResource);
  ("use strict");
  /**
   * @ngdoc service
  ...
  function contentResource($q, $http, umbDataFormatter, umbRequestHelper) {
    ...
    return {
      ...
      getRecycleBin: function getRecycleBin() {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("contentApiBaseUrl", "GetRecycleBin")
          ),
      ...
      move: function move(args) {
        ...
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("contentApiBaseUrl", "PostMove"),
            {
              parentId: args.parentId,
              id: args.id,
            },
      ...
      unpublish: function unpublish(id, cultures) {
        ...
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("contentApiBaseUrl", "PostUnpublish"),
            {
              id: id,
              cultures: cultures,
            }
      ...
      emptyRecycleBin: function emptyRecycleBin() {
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("contentApiBaseUrl", "EmptyRecycleBin")
          ),
      ...
      deleteById: function deleteById(id) {
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("contentApiBaseUrl", "DeleteById", [
              { id: id },
            ])
          ),
      ...
      deleteBlueprint: function deleteBlueprint(id) {
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("contentApiBaseUrl", "DeleteBlueprint", [
              { id: id },
            ])
          ),
      ...
      getById: function getById(id) {
        return umbRequestHelper
          .resourcePromise(
            $http.get(
              umbRequestHelper.getApiUrl("contentApiBaseUrl", "GetById", {
                id: id,
              })
            ),
      ...
      getScaffold: function getScaffold(parentId, alias) {
        return umbRequestHelper
          .resourcePromise(
            $http.get(
              umbRequestHelper.getApiUrl("contentApiBaseUrl", "GetEmpty", {
      ...
      getScaffoldByKey: function getScaffoldByKey(parentId, contentTypeKey) {
        return umbRequestHelper
          .resourcePromise(
            $http.get(
              umbRequestHelper.getApiUrl("contentApiBaseUrl", "GetEmptyByKey", {
                contentTypeKey: contentTypeKey,
                parentId: parentId,
              })
            ),
            "Failed to retrieve data for empty content item id " +
              contentTypeKey
          )
          .then(function (result) {
            return $q.when(umbDataFormatter.formatContentGetData(result));
      ...
      getBlueprintScaffold: function getBlueprintScaffold(
        parentId,
        blueprintId
      ) {
        return umbRequestHelper
      ...
      getNiceUrl: function getNiceUrl(id) {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("contentApiBaseUrl", "GetNiceUrl", {
              id: id,
            }),
            { responseType: "text" }
          ),
      ...
      getChildren: function getChildren(parentId, options) {
        ...
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("contentApiBaseUrl", "GetChildren", {
              id: parentId,
              includeProperties: _.pluck(
       ...
       *
       */
      saveBlueprint: function saveBlueprint(
        content,
        isNew,
        files,
        showNotifications
       ...
       *
       */
      publishWithDescendants: function publishWithDescendants(
        content,
        isNew,
        force,
        files,
       ...
       *
       */
      sendToPublish: function sendToPublish(
        content,
        isNew,
        files,
        showNotifications
      ...
      publishById: function publishById(id) {
        ...
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("contentApiBaseUrl", "PostPublishById", [
              { id: id },
            ])
          ),
          "Failed to publish content with id " + id
       ...
       *
       */
      createBlueprintFromContent: function createBlueprintFromContent(
        contentId,
        name
      ) {
        return umbRequestHelper.resourcePromise(
      ...
      getRollbackVersions: function getRollbackVersions(contentId, culture) {
        return umbRequestHelper.resourcePromise(
          ...
          "Failed to get rollback versions for content item with id " +
            contentId
        );
      },
      /**
       ...
       *
       */
      updatePublicAccess: function updatePublicAccess(
        contentId,
        groups,
        usernames,
        loginPageId,
  ...
  function contentTypeResource(
    ...
    return {
      ...
      getCount: function getCount() {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("contentTypeApiBaseUrl", "GetCount")
          ),
      ...
      getAvailableCompositeContentTypes:
        function getAvailableCompositeContentTypes(
          contentTypeId,
          filterContentTypes,
          filterPropertyTypes,
          isElement
      ...
      getWhereCompositionIsUsedInContentTypes:
        function getWhereCompositionIsUsedInContentTypes(contentTypeId) {
      ...
      getById: function getById(id) {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("contentTypeApiBaseUrl", "GetById", [
              { id: id },
            ])
          ),
      ...
      deleteById: function deleteById(id) {
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("contentTypeApiBaseUrl", "DeleteById", [
              { id: id },
            ])
          ),
      ...
      getAll: function getAll() {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("contentTypeApiBaseUrl", "GetAll")
          ),
      ...
      getScaffold: function getScaffold(parentId) {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("contentTypeApiBaseUrl", "GetEmpty", {
              parentId: parentId,
            })
          ),
      ...
      save: function save(contentType) {
        ...
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("contentTypeApiBaseUrl", "PostSave"),
            saveModel
          ),
      ...
      move: function move(args) {
        ...
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("contentTypeApiBaseUrl", "PostMove"),
            {
              parentId: args.parentId,
              id: args.id,
            },
      ...
      copy: function copy(args) {
        ...
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("contentTypeApiBaseUrl", "PostCopy"),
            {
              parentId: args.parentId,
              id: args.id,
            },
      ...
      export: function _export(id) {
        ...
        return umbRequestHelper.downloadFile(url).then(
          function () {
            localizationService
              .localize("speechBubbles_documentTypeExportedSuccess")
              .then(function (value) {
          ...
          function (data) {
            localizationService
              .localize("speechBubbles_documentTypeExportedError")
              .then(function (value) {
      ...
      import: function _import(file) {
        ...
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("contentTypeApiBaseUrl", "Import", {
              file: file,
            })
          ),
      ...
      hasContentNodes: function hasContentNodes(id) {
        return umbRequestHelper.resourcePromise(
          ...
          "Failed to retrieve indication for whether content type with id " +
            id +
            " has associated content nodes"
        );
      },
    };
  }
  angular
    .module("umbraco.resources")
    .factory("contentTypeResource", contentTypeResource);
  ("use strict");
  /**
   * @ngdoc service
  ...
  function currentUserResource($q, $http, umbRequestHelper, umbDataFormatter) {
    ...
    return {
      ...
      getTours: function getTours() {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("currentUserApiBaseUrl", "GetUserTours")
          ),
          "Failed to get tours"
        );
      },
      performSetInvitedUserPassword: function performSetInvitedUserPassword(
        newPassword
      ) {
        if (!newPassword) {
      ...
      changePassword: function changePassword(changePasswordArgs) {
        changePasswordArgs =
          umbDataFormatter.formatChangePasswordModel(changePasswordArgs);
  ...
  function dashboardResource($q, $http, umbRequestHelper) {
    ...
    return {
      ...
      getDashboard: function getDashboard(section) {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("dashboardApiBaseUrl", "GetDashboard", [
              { section: section },
            ])
          ),
       ...
       *
       */
      getRemoteDashboardContent: function getRemoteDashboardContent(
        section,
        baseurl
      ) {
        ...
        return umbRequestHelper.resourcePromise(
          ...
          "Failed to get dashboard content"
        );
      },
      getRemoteDashboardCssUrl: function getRemoteDashboardCssUrl(
        section,
        baseurl
      ) {
        //build request values with optional params
  ...
  function dataTypeResource($q, $http, umbDataFormatter, umbRequestHelper) {
    return {
      ...
      getPreValues: function getPreValues(editorAlias, dataTypeId) {
        ...
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("dataTypeApiBaseUrl", "GetPreValues", [
      ...
      getReferences: function getReferences(id) {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("dataTypeApiBaseUrl", "GetReferences", {
              id: id,
            })
          ),
      ...
      getById: function getById(id) {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("dataTypeApiBaseUrl", "GetById", [
              { id: id },
            ])
          ),
      ...
      getByName: function getByName(name) {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("dataTypeApiBaseUrl", "GetByName", [
              { name: name },
            ])
          ),
      ...
      getAll: function getAll() {
        return umbRequestHelper.resourcePromise(
          $http.get(umbRequestHelper.getApiUrl("dataTypeApiBaseUrl", "GetAll")),
      ...
      getScaffold: function getScaffold(parentId) {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("dataTypeApiBaseUrl", "GetEmpty", {
              parentId: parentId,
            })
          ),
      ...
      deleteById: function deleteById(id) {
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("dataTypeApiBaseUrl", "DeleteById", [
              { id: id },
            ])
          ),
          "Failed to delete item " + id
      ...
      save: function save(dataType, preValues, isNew) {
        var saveModel = umbDataFormatter.formatDataTypePostData(
          dataType,
          preValues,
          "save" + (isNew ? "New" : "")
        );
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("dataTypeApiBaseUrl", "PostSave"),
            saveModel
          ),
      ...
      move: function move(args) {
        ...
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("dataTypeApiBaseUrl", "PostMove"),
            {
              parentId: args.parentId,
              id: args.id,
            },
  ...
  angular
    .module("umbraco.resources")
    .factory("dataTypeResource", dataTypeResource);
  ("use strict");
  /**
   * @ngdoc service
  ...
  function dictionaryResource(
    ...
    function deleteById(id) {
      return umbRequestHelper.resourcePromise(
        $http.post(
          umbRequestHelper.getApiUrl("dictionaryApiBaseUrl", "DeleteById", [
            { id: id },
          ])
        ),
        "Failed to delete item " + id
    ...
    function create(parentid, key) {
      return umbRequestHelper.resourcePromise(
        $http.post(
          umbRequestHelper.getApiUrl("dictionaryApiBaseUrl", "Create", {
            parentId: parentid,
            key: key,
          })
        ),
    ...
    function getById(id) {
      return umbRequestHelper.resourcePromise(
        $http.get(
          umbRequestHelper.getApiUrl("dictionaryApiBaseUrl", "GetById", [
            { id: id },
          ])
        ),
    ...
    function save(dictionary, nameIsDirty) {
      var saveModel = umbDataFormatter.formatDictionaryPostData(
        dictionary,
        nameIsDirty
      );
      return umbRequestHelper.resourcePromise(
        $http.post(
          umbRequestHelper.getApiUrl("dictionaryApiBaseUrl", "PostSave"),
          saveModel
        ),
    ...
    function getList() {
      return umbRequestHelper.resourcePromise(
        $http.get(
          umbRequestHelper.getApiUrl("dictionaryApiBaseUrl", "getList")
        ),
        "Failed to get list"
      );
    }
  ...
  angular
    .module("umbraco.resources")
    .factory("dictionaryResource", dictionaryResource);
  ("use strict");
  /**
   * @ngdoc service
  ...
  function elementTypeResource($q, $http, umbRequestHelper) {
    return {
      ...
      getAll: function getAll() {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("elementTypeApiBaseUrl", "GetAll")
          ),
  ...
  angular
    .module("umbraco.resources")
    .factory("elementTypeResource", elementTypeResource);
  ("use strict");
  /**
   * @ngdoc service
  ...
  angular
    .module("umbraco.resources")
    .factory("emailMarketingResource", emailMarketingResource);
  ("use strict");
  /**
   * @ngdoc service
  ...
  function entityResource($q, $http, umbRequestHelper) {
    ...
    return {
      getSafeAlias: function getSafeAlias(value, camelCase) {
        ...
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("entityApiBaseUrl", "GetSafeAlias", {
      ...
      getPath: function getPath(id, type) {
        ...
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("entityApiBaseUrl", "GetPath", [
              { id: id },
              { type: type },
            ])
          ),
      ...
      getUrl: function getUrl(id, type, culture) {
        ...
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("entityApiBaseUrl", "GetUrl", [
              { id: id },
              { type: type },
              { culture: culture },
            ])
      ...
      getById: function getById(id, type) {
        ...
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("entityApiBaseUrl", "GetById", [
              { id: id },
              { type: type },
            ])
          ),
      ...
      getUrlAndAnchors: function getUrlAndAnchors(id, culture) {
        ...
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("entityApiBaseUrl", "GetUrlAndAnchors", [
              { id: id },
              { culture: culture },
            ])
          ),
      ...
      getAnchors: function getAnchors(rteContent) {
        ...
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("entityApiBaseUrl", "GetAnchors"),
      ...
      getByIds: function getByIds(ids, type) {
        ...
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("entityApiBaseUrl", "GetByIds", query),
            { ids: ids }
          ),
      ...
      getByQuery: function getByQuery(query, nodeContextId, type) {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("entityApiBaseUrl", "GetByQuery", [
              { query: query },
      ...
      getAll: function getAll(type, postFilter) {
        ...
        var query =
          ...
          type +
          "&postFilter=" +
          (postFilter ? encodeURIComponent(postFilter) : "");
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("entityApiBaseUrl", "GetAll", query)
          ),
      ...
      getAncestors: function getAncestors(id, type, culture, options) {
        ...
        var args = [{ id: id }, { type: type }, { culture: culture }];
        if (options && options.dataTypeKey) {
          args.push({ dataTypeKey: options.dataTypeKey });
        }
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("entityApiBaseUrl", "GetAncestors", args)
          ),
      ...
      getChildren: function getChildren(id, type, options) {
        ...
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("entityApiBaseUrl", "GetChildren", args)
          ),
      ...
      getPagedChildren: function getPagedChildren(parentId, type, options) {
        ...
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("entityApiBaseUrl", "GetPagedChildren", {
              id: parentId,
              type: type,
              pageNumber: options.pageNumber,
              pageSize: options.pageSize,
       ...
       *
       */
      getPagedDescendants: function getPagedDescendants(
        parentId,
        type,
        options
      ) {
      ...
      search: function search(query, type, searchFrom, canceler, dataTypeKey) {
        ...
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("entityApiBaseUrl", "Search", args),
            httpConfig
          ),
          "Failed to retrieve entity data for query " + query
        );
      ...
      searchAll: function searchAll(query, canceler) {
        ...
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("entityApiBaseUrl", "SearchAll", [
              { query: query },
            ]),
            httpConfig
          ),
  ...
  (function () {
    ...
    function healthCheckResource($http, umbRequestHelper) {
      ...
      function getAllChecks() {
        return umbRequestHelper.resourcePromise(
          $http.get(
            Umbraco.Sys.ServerVariables.umbracoUrls.healthCheckBaseUrl +
              "GetAllHealthChecks"
          ),
      ...
      function executeAction(action) {
        return umbRequestHelper.resourcePromise(
          ...
          "Failed to execute action with alias " +
            action.alias +
            " and healthCheckId + " +
    ...
    angular
      .module("umbraco.resources")
      .factory("healthCheckResource", healthCheckResource);
  })();
  ("use strict");
  /**
   * @ngdoc service
  ...
  (function () {
    ...
    angular
      .module("umbraco.resources")
      .factory("imageUrlGeneratorResource", imageUrlGeneratorResource);
  })();
  ("use strict");
  (function () {
    "use strict";
    ...
    angular
      .module("umbraco.resources")
      .factory("javascriptLibraryResource", javascriptLibraryResource);
  })();
  ("use strict");
  /**
   * @ngdoc service
  ...
  function languageResource($http, umbRequestHelper) {
    return {
      getCultures: function getCultures() {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("languageApiBaseUrl", "GetAllCultures")
          ),
          "Failed to get cultures"
        );
      },
      getAll: function getAll() {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("languageApiBaseUrl", "GetAllLanguages")
          ),
      ...
      getById: function getById(id) {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("languageApiBaseUrl", "GetLanguage", {
              id: id,
            })
          ),
      ...
      save: function save(lang) {
        if (!lang) throw "'lang' parameter cannot be null";
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("languageApiBaseUrl", "SaveLanguage"),
            lang
          ),
      ...
      deleteById: function deleteById(id) {
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("languageApiBaseUrl", "DeleteLanguage", {
              id: id,
            })
          ),
          "Failed to delete item " + id
  ...
  function logResource($q, $http, umbRequestHelper) {
    ...
    return {
      ...
      getEntityLog: function getEntityLog(id) {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("logApiBaseUrl", "GetEntityLog", [
              { id: id },
            ])
          ),
      ...
      getUserLog: function getUserLog(type, since) {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("logApiBaseUrl", "GetCurrentUserLog", [
              { logtype: type },
              { sinceDate: dateToValidIsoString(since) },
            ])
          ),
          "Failed to retrieve log data for current user of type " +
            type +
            " since " +
            since
        );
      ...
      getLog: function getLog(type, since) {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("logApiBaseUrl", "GetLog", [
              { logtype: type },
              { sinceDate: dateToValidIsoString(since) },
            ])
          ),
  ...
  function logViewerResource($q, $http, umbRequestHelper) {
    ...
    var request = function request(verb, method, params, error) {
      return umbRequestHelper.resourcePromise(
        verb === "GET"
          ? $http.get(
              umbRequestHelper.getApiUrl("logViewerApiBaseUrl", method) +
                (params ? params : "")
            )
          : $http.post(
              umbRequestHelper.getApiUrl("logViewerApiBaseUrl", method),
  ...
  angular
    .module("umbraco.resources")
    .factory("logViewerResource", logViewerResource);
  ("use strict");
  /**
   * @ngdoc service
  ...
  function macroResource($q, $http, umbRequestHelper) {
    ...
    return {
       ...
       *
       */
      getMacroResultAsHtmlForEditor: function getMacroResultAsHtmlForEditor(
        macroAlias,
        pageId,
        macroParamDictionary
      ) {
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl(
       ...
       * @returns {}
       */
      createPartialViewMacroWithFile: function createPartialViewMacroWithFile(
        virtualPath,
        filename
      ) {
        return umbRequestHelper.resourcePromise(
      ...
      createMacro: function createMacro(name) {
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("macroApiBaseUrl", "Create?name=" + name)
          ),
      ...
      getPartialViews: function getPartialViews() {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("macroApiBaseUrl", "GetPartialViews"),
      ...
      getById: function getById(id) {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("macroApiBaseUrl", "GetById", {
              id: id,
            }),
            "Failed to get macro"
          )
      ...
      saveMacro: function saveMacro(macro) {
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("macroApiBaseUrl", "Save"),
            macro
          )
        );
      },
      deleteById: function deleteById(id) {
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("macroApiBaseUrl", "deleteById", {
              id: id,
            })
          )
        );
  ...
  function mediaResource($q, $http, umbDataFormatter, umbRequestHelper) {
    ...
    return {
      getRecycleBin: function getRecycleBin() {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("mediaApiBaseUrl", "GetRecycleBin")
          ),
      ...
      sort: function sort(args) {
        ...
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("mediaApiBaseUrl", "PostSort"),
            {
              parentId: args.parentId,
              idSortOrder: args.sortedIds,
            }
      ...
      move: function move(args) {
        ...
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("mediaApiBaseUrl", "PostMove"),
            {
              parentId: args.parentId,
              id: args.id,
            },
      ...
      getById: function getById(id) {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("mediaApiBaseUrl", "GetById", [
              { id: id },
            ])
          ),
      ...
      deleteById: function deleteById(id) {
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("mediaApiBaseUrl", "DeleteById", [
              { id: id },
            ])
          ),
          "Failed to delete item " + id
      ...
      getByIds: function getByIds(ids) {
        ...
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("mediaApiBaseUrl", "GetByIds", idQuery)
          ),
      ...
      getScaffold: function getScaffold(parentId, alias) {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("mediaApiBaseUrl", "GetEmpty", [
              { contentTypeAlias: alias },
              { parentId: parentId },
            ])
          ),
      ...
      rootMedia: function rootMedia() {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("mediaApiBaseUrl", "GetRootMedia")
          ),
      ...
      getChildren: function getChildren(parentId, options) {
        ...
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("mediaApiBaseUrl", "GetChildren", [
              { id: parentId },
              { pageNumber: options.pageNumber },
              { pageSize: options.pageSize },
              { orderBy: options.orderBy },
      ...
      addFolder: function addFolder(name, parentId) {
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("mediaApiBaseUrl", "PostAddFolder"),
            {
              name: name,
              parentId: parentId,
            }
      ...
      getChildFolders: function getChildFolders(parentId) {
        ...
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("mediaApiBaseUrl", "GetChildFolders", {
              id: parentId,
              pageNumber: 1,
              pageSize: 500,
            })
      ...
      search: function search(query, pageNumber, pageSize, searchFrom) {
        ...
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("mediaApiBaseUrl", "Search", args)
          ),
  ...
  function mediaTypeResource(
    ...
    return {
      getCount: function getCount() {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("mediaTypeApiBaseUrl", "GetCount")
          ),
          "Failed to retrieve count"
        );
      },
      ...
      getById: function getById(id) {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("mediaTypeApiBaseUrl", "GetById", [
              { id: id },
            ])
          ),
          "Failed to retrieve content type"
      ...
      getAll: function getAll() {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("mediaTypeApiBaseUrl", "GetAll")
          ),
          "Failed to retrieve all content types"
        );
      },
      getScaffold: function getScaffold(parentId) {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("mediaTypeApiBaseUrl", "GetEmpty", {
              parentId: parentId,
            })
          ),
          "Failed to retrieve content type scaffold"
      ...
      deleteById: function deleteById(id) {
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("mediaTypeApiBaseUrl", "DeleteById", [
              { id: id },
            ])
          ),
          "Failed to retrieve content type"
      ...
      save: function save(contentType) {
        ...
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("mediaTypeApiBaseUrl", "PostSave"),
            saveModel
          ),
          "Failed to save data for content type id " + contentType.id
        );
      ...
      move: function move(args) {
        ...
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("mediaTypeApiBaseUrl", "PostMove"),
            {
              parentId: args.parentId,
              id: args.id,
            },
      ...
      copy: function copy(args) {
        ...
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("mediaTypeApiBaseUrl", "PostCopy"),
            {
              parentId: args.parentId,
              id: args.id,
            },
      ...
      createContainer: function createContainer(parentId, name) {
        var promise = localizationService.localize("media_createFolderFailed", [
          parentId,
        ]);
        return umbRequestHelper.resourcePromise(
          $http.post(
      ...
      renameContainer: function renameContainer(id, name) {
        var promise = localizationService.localize("media_renameFolderFailed", [
          id,
        ]);
        return umbRequestHelper.resourcePromise(
          $http.post(
  ...
  angular
    .module("umbraco.resources")
    .factory("mediaTypeResource", mediaTypeResource);
  ("use strict");
  /**
   * @ngdoc service
  ...
  function memberResource($q, $http, umbDataFormatter, umbRequestHelper) {
    ...
    return {
      ...
      getByKey: function getByKey(key) {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("memberApiBaseUrl", "GetByKey", [
              { key: key },
            ])
          ),
      ...
      deleteByKey: function deleteByKey(key) {
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("memberApiBaseUrl", "DeleteByKey", [
              { key: key },
            ])
          ),
      ...
      getScaffold: function getScaffold(alias) {
        if (alias) {
          return umbRequestHelper.resourcePromise(
            $http.get(
              umbRequestHelper.getApiUrl("memberApiBaseUrl", "GetEmpty", [
                { contentTypeAlias: alias },
              ])
            ),
  ...
  function memberGroupResource($q, $http, umbRequestHelper) {
    return {
      ...
      getGroups: function getGroups() {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("memberGroupApiBaseUrl", "GetAllGroups")
          ),
      ...
      getById: function getById(id) {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("memberGroupApiBaseUrl", "GetById", [
              { id: id },
            ])
          ),
      ...
      deleteById: function deleteById(id) {
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("memberGroupApiBaseUrl", "DeleteById", [
              { id: id },
            ])
          ),
      ...
      getScaffold: function getScaffold() {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("memberGroupApiBaseUrl", "GetEmpty")
          ),
      ...
      save: function save(memberGroup) {
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("memberGroupApiBaseUrl", "PostSave"),
            memberGroup
          ),
  ...
  angular
    .module("umbraco.resources")
    .factory("memberGroupResource", memberGroupResource);
  ("use strict");
  /**
   * @ngdoc service
  ...
  function memberTypeResource(
    ...
    return {
      ...
      getTypes: function getTypes() {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("memberTypeApiBaseUrl", "GetAllTypes")
          ),
      ...
      getById: function getById(id) {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("memberTypeApiBaseUrl", "GetById", [
              { id: id },
            ])
          ),
          "Failed to retrieve content type"
      ...
      deleteById: function deleteById(id) {
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("memberTypeApiBaseUrl", "DeleteById", [
              { id: id },
            ])
          ),
      ...
      getScaffold: function getScaffold() {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("memberTypeApiBaseUrl", "GetEmpty")
          ),
          "Failed to retrieve content type scaffold"
        );
      },
      ...
      save: function save(contentType) {
        ...
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("memberTypeApiBaseUrl", "PostSave"),
            saveModel
          ),
      ...
      copy: function copy(args) {
        ...
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("memberTypeApiBaseUrl", "PostCopy"),
            {
              parentId: args.parentId,
              id: args.id,
            },
  ...
  angular
    .module("umbraco.resources")
    .factory("memberTypeResource", memberTypeResource);
  ("use strict");
  /**
   * @ngdoc service
  ...
  function modelsBuilderManagementResource($q, $http, umbRequestHelper) {
    return {
      ...
      buildModels: function buildModels() {
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("modelsBuilderBaseUrl", "BuildModels")
          ),
      ...
      getDashboard: function getDashboard() {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("modelsBuilderBaseUrl", "GetDashboard")
          ),
  ...
  angular
    .module("umbraco.resources")
    .factory(
      "modelsBuilderManagementResource",
      modelsBuilderManagementResource
    );
  ("use strict");
  angular
        ...
        return {
          getContentTypes: function getContentTypes() {
            var url =
              ...
              "/backoffice/UmbracoApi/NestedContent/GetContentTypes";
            return umbRequestHelper.resourcePromise(
              $http.get(url),
   ...
   **/
  function ourPackageRepositoryResource(
    $q,
    $http,
    umbDataFormatter,
    umbRequestHelper
    ...
    var baseurl =
      Umbraco.Sys.ServerVariables.umbracoUrls.packagesRestApiBaseUrl;
    return {
  ...
  angular
    .module("umbraco.resources")
    .factory("ourPackageRepositoryResource", ourPackageRepositoryResource);
  ("use strict");
  /**
   * @ngdoc service
  ...
  function packageResource($q, $http, umbDataFormatter, umbRequestHelper) {
    return {
      ...
      getInstalled: function getInstalled() {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("packageApiBaseUrl", "GetInstalled")
          ),
      ...
      fetch: function fetch(id) {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("packageInstallApiBaseUrl", "Fetch", [
              { packageGuid: id },
            ])
          ),
      ...
      getEmpty: function getEmpty() {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("packageApiBaseUrl", "getEmpty")
          ),
      ...
      savePackage: function savePackage(umbPackage) {
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("packageApiBaseUrl", "PostSavePackage"),
            umbPackage
          ),
  ...
  angular
    .module("umbraco.resources")
    .factory("packageResource", packageResource);
  ("use strict");
  /**
   * @ngdoc service
  ...
  (function () {
    ...
    angular
      .module("umbraco.resources")
      .factory("redirectUrlsResource", redirectUrlsResource);
  })();
  ("use strict");
  /**
   * @ngdoc service
  ...
  function relationResource($q, $http, umbRequestHelper) {
    return {
      ...
      getByChildId: function getByChildId(id, alias) {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("relationApiBaseUrl", "GetByChildId", {
              childId: id,
      ...
      deleteById: function deleteById(id) {
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("relationApiBaseUrl", "DeleteById", [
              { id: id },
            ])
          ),
          "Failed to delete item " + id
  ...
  angular
    .module("umbraco.resources")
    .factory("relationResource", relationResource);
  ("use strict");
  /**
   * @ngdoc service
  ...
  function relationTypeResource($q, $http, umbRequestHelper, umbDataFormatter) {
    return {
      ...
      getById: function getById(id) {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("relationTypeApiBaseUrl", "GetById", [
              { id: id },
            ])
          ),
          "Failed to get item " + id
      ...
      save: function save(relationType) {
        var saveModel =
          umbDataFormatter.formatRelationTypePostData(relationType);
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("relationTypeApiBaseUrl", "PostSave"),
            saveModel
          ),
      ...
      create: function create(relationType) {
        ...
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("relationTypeApiBaseUrl", "PostCreate"),
            createModel
          ),
      ...
      deleteById: function deleteById(id) {
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("relationTypeApiBaseUrl", "DeleteById", [
              { id: id },
            ])
          ),
          "Failed to delete item " + id
  ...
  angular
    .module("umbraco.resources")
    .factory("relationTypeResource", relationTypeResource);
  ("use strict");
  /**
   * @ngdoc service
  ...
  function sectionResource($q, $http, umbRequestHelper) {
    ...
    return {
      ...
      getSections: function getSections() {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("sectionApiBaseUrl", "GetSections")
          ),
      ...
      getAllSections: function getAllSections() {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("sectionApiBaseUrl", "GetAllSections")
          ),
          "Failed to retrieve data for sections"
        );
      },
  ...
  angular
    .module("umbraco.resources")
    .factory("sectionResource", sectionResource);
  ("use strict");
  /**
   * @ngdoc service
  ...
  function stylesheetResource($q, $http, umbRequestHelper) {
    ...
    return {
      ...
      getAll: function getAll() {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("stylesheetApiBaseUrl", "GetAll")
          ),
  ...
  angular
    .module("umbraco.resources")
    .factory("stylesheetResource", stylesheetResource);
  ("use strict");
  /**
   * @ngdoc service
  ...
  function templateResource(
    ...
    return {
      ...
      getById: function getById(id) {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("templateApiBaseUrl", "GetById", [
              { id: id },
            ])
          ),
      ...
      getAll: function getAll() {
        return umbRequestHelper.resourcePromise(
          $http.get(umbRequestHelper.getApiUrl("templateApiBaseUrl", "GetAll")),
          "Failed to retrieve data"
        );
      },
      /**
      ...
      getScaffold: function getScaffold(id) {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("templateApiBaseUrl", "GetScaffold", [
              { id: id },
            ])
          ),
      ...
      deleteById: function deleteById(id) {
        ...
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("templateApiBaseUrl", "DeleteById", [
              { id: id },
            ])
          ),
          promise
      ...
      save: function save(template) {
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("templateApiBaseUrl", "PostSave"),
            template
          ),
  ...
  (function () {
    ...
    angular
      .module("umbraco.resources")
      .factory("templateQueryResource", templateQueryResource);
  })();
  ("use strict");
  /**
   * @ngdoc service
  ...
  (function () {
    ...
    function tourResource($http, umbRequestHelper, $q, umbDataFormatter) {
      function getTours() {
        return umbRequestHelper.resourcePromise(
          $http.get(umbRequestHelper.getApiUrl("tourApiBaseUrl", "GetTours")),
          "Failed to get tours"
        );
      }
      function getToursForDoctype(doctypeAlias) {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("tourApiBaseUrl", "GetToursForDoctype", [
  ...
  function treeResource($q, $http, umbRequestHelper) {
    ...
    return {
      ...
      loadMenu: function loadMenu(node) {
        ...
        if (
          treeMenuUrl !== undefined &&
          treeMenuUrl !== null &&
          treeMenuUrl.length > 0
        ) {
          return umbRequestHelper.resourcePromise(
  ...
  (function () {
    ...
    function userGroupsResource($http, umbRequestHelper, $q, umbDataFormatter) {
      ...
      function saveUserGroup(userGroup, isNew) {
        ...
        var formattedSaveData = umbDataFormatter.formatUserGroupPostData(
          userGroup,
          "save" + (isNew ? "New" : "")
        );
        return umbRequestHelper.resourcePromise(
      ...
      function getUserGroup(id) {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("userGroupsApiBaseUrl", "GetUserGroup", {
              id: id,
            })
          ),
      ...
      function getUserGroups(args) {
        ...
        if (
          args.onlyCurrentUserGroups === undefined ||
          args.onlyCurrentUserGroups === null
        ) {
          args.onlyCurrentUserGroups = true;
        }
        return umbRequestHelper.resourcePromise(
    ...
    angular
      .module("umbraco.resources")
      .factory("userGroupsResource", userGroupsResource);
  })();
  ("use strict");
  /**
   * @ngdoc service
  ...
  (function () {
    ...
    function usersResource($http, umbRequestHelper, $q, umbDataFormatter) {
      ...
      function clearAvatar(userId) {
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("userApiBaseUrl", "PostClearAvatar", {
              id: userId,
            })
          ),
      ...
      function enableUsers(userIds) {
        ...
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("userApiBaseUrl", "PostEnableUsers", qry)
          ),
      ...
      function unlockUsers(userIds) {
        ...
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("userApiBaseUrl", "PostUnlockUsers", qry)
          ),
          "Failed to enable the users " + userIds.join(",")
        );
      }
      ...
      function setUserGroupsOnUsers(userGroups, userIds) {
        ...
        var query =
          "userGroupAliases=" +
          userGroupAliases.join("&userGroupAliases=") +
          "&userIds=" +
      ...
      function getPagedResults(options) {
        ...
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("userApiBaseUrl", "GetPagedUsers", qry)
          ),
      ...
      function getUser(userId) {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("userApiBaseUrl", "GetById", {
              id: userId,
            })
          ),
      ...
      function getUsers(userIds) {
        return umbRequestHelper.resourcePromise(
          $http.get(
            umbRequestHelper.getApiUrl("userApiBaseUrl", "GetByIds", {
              ids: userIds,
            })
          ),
      ...
      function createUser(user) {
        ...
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("userApiBaseUrl", "PostCreateUser"),
            formattedSaveData
          ),
          "Failed to save user"
        );
      ...
      function inviteUser(user) {
        ...
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("userApiBaseUrl", "PostInviteUser"),
            formattedSaveData
          ),
      ...
      function saveUser(user) {
        ...
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("userApiBaseUrl", "PostSaveUser"),
            formattedSaveData
          ),
          "Failed to save user"
        );
      ...
      function changePassword(changePasswordModel) {
        ...
        var formattedPasswordData =
          umbDataFormatter.formatChangePasswordModel(changePasswordModel);
        return umbRequestHelper.resourcePromise(
          $http.post(
            umbRequestHelper.getApiUrl("userApiBaseUrl", "PostChangePassword"),

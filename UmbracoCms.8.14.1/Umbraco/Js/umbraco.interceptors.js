(function () {
  "use strict";
  angular
    .module("umbraco.interceptors", []) // We have to add the interceptor to the queue as a string because the interceptor depends upon service instances that are not available in the config block.
    .config([
      "$httpProvider",
      function ($httpProvider) {
        ...
        $httpProvider.interceptors.push(
          "doNotPostDollarVariablesOnPostRequestInterceptor"
        );
  ...
  (function () {
      ...
      return {
        ...
        request: function request(config) {
          ...
          if ($routeParams) {
            ...
            config.headers["X-UMB-CULTURE"] = $routeParams.cculture
              ? $routeParams.cculture
              : $routeParams.mculture;
            config.headers["X-UMB-SEGMENT"] = $routeParams.csegment
              ? $routeParams.csegment
              : null;
          }
          return config;
        },
    ...
    angular
      .module("umbraco.interceptors")
      .factory("cultureRequestInterceptor", cultureRequestInterceptor);
  })();
  ("use strict");
  (function () {
    "use strict";
    ...
    angular
      .module("umbraco.interceptors")
      .factory("debugRequestInterceptor", debugRequestInterceptor);
  })();
  ("use strict");
  ...
  (function () {
    ...
    function removeProperty(obj, propertyPrefix) {
      for (var property in obj) {
        if (obj.hasOwnProperty(property)) {
          if (
            property.startsWith(propertyPrefix) &&
    ...
    angular
      ...
      .factory(
        "doNotPostDollarVariablesOnPostRequestInterceptor",
        doNotPostDollarVariablesRequestInterceptor
      );
  })();
  ("use strict");
  (function () {
    ...
    angular
      .module("umbraco.interceptors")
      .value("requestInterceptorFilter", requestInterceptorFilter);
  })();
  ("use strict");
  (function () {
    "use strict";
    ...
    angular
      .module("umbraco.interceptors")
      .factory("requiredHeadersInterceptor", requiredHeadersInterceptor);
  })();
  ("use strict");
  (function () {
    "use strict";
    ...
    function securityInterceptor(
      ...
      return {
        ...
        responseError: function responseError(rejection) {
          ...
          if (
            headers["x-umb-ignore-error"] === "ignore" ||
            config.umbIgnoreErrors === true ||
            (Utilities.isArray(config.umbIgnoreStatus) &&
              config.umbIgnoreStatus.indexOf(rejection.status) !== -1)
          ) {
            //exit/ignore
          ...
          if (rejection.status === 401) {
            ...
            var getCurrentUserPath = umbRequestHelper.getApiUrl(
            ...
            if (!rejection.config.url.endsWith(getCurrentUserPath)) {
              ...
              return userService.getCurrentUser().then(function (user) {
                ...
                return requestRetryQueue.pushRetryFn(
                  "unauthorized-server",
                  userName,
            ...
            var errMsg =
              "The URL returned a 404 (not found): <br/><i>" +
            ...
            var msg =
              "Unauthorized access to URL: <br/><i>" +
              rejection.config.url.split("?")[0] +
              "</i><br/>Contact your administrator for information.";

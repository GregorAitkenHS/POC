(function () {
  ...
  /*********************************************************************************************************/
  var app = angular
    .module("umbraco.preview", ["umbraco.resources", "umbraco.services"])
    .controller(
      "previewController",
      function ($scope, $window, $location, $http) {
        ...
        function configureSignalR(iframe) {
          ...
          $.connection.hub
            ...
            .done(function () {
              console.log(
                "Connected to SignalR preview hub (ID=" +
                  $.connection.hub.id +
                  ")"
              );
            })
        ...
        function windowVisibilityHandler(e) {
          var amountOfPreviewSessions = localStorage.getItem(
            "UmbPreviewSessionAmount"
          );
        ...
        function setPageUrl() {
          ...
          var culture =
            $location.search().culture || getParameterByName("culture");
          if ($scope.pageId) {
        ...
        function checkPreviewState() {
          if (getCookie("UMB_PREVIEW") === null) {
            ...
            var umbLocalizedVars = Object.assign(
              localizeVarsFallback,
            ...
            modal.innerHTML = '<div class="umbraco-preview-dialog__headline">'
              .concat(
                umbLocalizedVars.returnToPreviewHeadline,
                '</div>\n                    <div class="umbraco-preview-dialog__question">'
              )
              .concat(umbLocalizedVars.returnToPreviewDescription, "</div>");
            con.appendChild(modal);
            var declineButton = document.createElement("button");
            declineButton.type = "button";
            declineButton.innerHTML =
              umbLocalizedVars.returnToPreviewDeclineButton;
            ...
            continueButton.innerHTML =
              umbLocalizedVars.returnToPreviewAcceptButton;
        ...
        function startPreviewSession() {
          ...
          var amountOfPreviewSessions = Math.max(
            localStorage.getItem("UmbPreviewSessionAmount") || 0,
            0
          );
        ...
        $scope.exitPreview = function () {
          ...
          window.top.location.href =
            "../preview/end?redir=" + encodeURIComponent(getPageURL());
        };
    ...
    .component("previewIFrame", {
      template:
        "<div style='width:100%;height:100%;margin:0 auto;overflow:hidden;'><iframe id='resultFrame' src='about:blank' ng-src=\"{{vm.src}}\" frameborder='0'></iframe></div>",
      controller: function controller($element, $scope, angularHelper) {
        ...
        function hideUmbracoPreviewBadge(iframe) {
          if (
            ...
            iframe.contentDocument.getElementById("umbracoPreviewBadge")
          ) {

(function () {
  ...
  angular
    ...
    .directive(
      "navResize",
      function (appState, eventsService, windowResizeListener) {
        return {
          restrict: "A",
          link: function link(scope, element, attrs, ctrl) {
            ...
            function setTreeMode() {
              appState.setGlobalState(
                "showNavigation",
                appState.getGlobalState("isTablet") === false
              );
            }
            ...
            function resetResize() {
              if (resizeEnabled) {
                ...
                element.css("width", "");
                var navInnerContainer = element.find(
  ...
  (function () {
    ...
    function AppHeaderDirective(
      ...
      function link(scope, el, attr, ctrl) {
        ...
        evts.push(
          eventsService.on("app.userRefresh", function (evt) {
      ...
      var directive = {
        ...
        replace: true,
        template:
          ' <div> <div class="umb-app-header"> <umb-sections ng-if="authenticated" sections="sections"> </umb-sections> <div class="flex items-center"> <ul class="umb-app-header__actions"> <li data-element="global-search" class="umb-app-header__action"> <button type="button" class="umb-app-header__button btn-reset" hotkey="ctrl+space" ng-click="searchClick()" ng-mousedown="rememberFocus()"> <span class="sr-only"> <localize key="visuallyHiddenTexts_openBackofficeSearch">Open backoffice search</localize>... </span> <umb-icon icon="icon-search" class="umb-app-header__action-icon icon-search"></umb-icon> </button> </li> <li data-element="global-help" class="umb-app-header__action"> <button type="button" class="umb-app-header__button btn-reset" hotkey="ctrl+shift+h" ng-click="helpClick()"> <span class="sr-only"> <localize key="visuallyHiddenTexts_openCloseBackofficeHelp">Open/Close backoffice help</localize>... </span> <umb-icon icon="icon-help-alt" class="umb-app-header__action-icon icon-help-alt"></umb-icon> </button> </li> <li data-element="global-user" class="umb-app-header__action"> <button type="button" class="umb-app-header__button btn-reset" ng-click="avatarClick()" hotkey="ctrl+shift+u" title="{{user.name}}"> <span class="sr-only"> <localize key="visuallyHiddenTexts_openCloseBackofficeProfileOptions">Open/Close your profile options</localize>... </span> <umb-avatar class="umb-app-header__action-icon" size="xxs" color="secondary" name="{{user.name}}" img-src="{{avatar[0].value}}" img-srcset="{{avatar[1].value}} 2x, {{avatar[2].value}} 3x"> </umb-avatar> </button> </li> </ul> </div> </div> </div> ',
        link: link,
        scope: {},
      };
      return directive;
    ...
    angular
      .module("umbraco.directives")
      .directive("umbAppHeader", AppHeaderDirective);
  })();
  ("use strict");
  (function () {
    "use strict";
    function BackdropDirective($timeout, $http) {
      function link(scope, el, attr, ctrl) {
          ...
          $timeout(function () {
            ...
            if (highlightElement && highlightElement.length > 0) {
              ...
              if (scope.highlightPreventClick) {
                var preventClickElement = el.find(
        ...
        events.push(
          scope.$watch("highlightElement", function (newValue, oldValue) {
            if (!newValue) {
              return;
            }
    ...
    angular
      .module("umbraco.directives")
      .directive("umbBackdrop", BackdropDirective);
  })();
  ("use strict");
  /**
   * @ngdoc directive
  ...
  angular
    ...
    .directive(
      "umbContextMenu",
      function (navigationService, keyboardService, backdropService) {
        return {
          scope: {
            menuDialogTitle: "@",
            currentSection: "@",
          ...
          link: function link(scope, element, attrs, ctrl) {
            ...
            scope.executeMenuItem = function (action) {
              navigationService.executeMenuAction(
                action,
                scope.currentNode,
...
**/
  function Drawer(
    ...
    return {
      ...
      template:
        '<div class="umb-drawer"> <div style="height: 100%;" ng-if="configuredView" ng-include="configuredView"></div> </div>',
      transclude: true,
      scope: {
        view: "=?",
        model: "=?",
        ...
        function setView() {
          if (scope.view) {
            ...
            if (scope.view.indexOf(".html") === -1) {
              ...
              configuredView =
                "views/common/drawers/" + viewAlias + "/" + viewAlias + ".html";
            }
...
**/
  (function () {
    ...
    angular
      .module("umbraco.directives")
      .directive("umbDrawerContent", DrawerContentDirective);
  })();
  ("use strict");
  /**
@ngdoc directive
...
**/
  (function () {
    ...
    angular
      .module("umbraco.directives")
      .directive("umbDrawerFooter", DrawerFooterDirective);
  })();
  ("use strict");
  /**
@ngdoc directive
  ...
  (function () {
    ...
    function DrawerHeaderDirective() {
      var directive = {
        ...
        replace: true,
        template:
          '<div class="umb-drawer-header"> <div class="umb-drawer-header__title">{{ title }}</div> <div class="umb-drawer-header__subtitle">{{ description }}</div> </div>',
        scope: {
          title: "@?",
          description: "@?",
        },
    ...
    angular
      .module("umbraco.directives")
      .directive("umbDrawerHeader", DrawerHeaderDirective);
  })();
  ("use strict");
  /**
@ngdoc directive
...
**/
  (function () {
    ...
    angular
      .module("umbraco.directives")
      .directive("umbDrawerView", DrawerViewDirective);
  })();
  ("use strict");
  (function () {
    "use strict";
    ...
    function UmbLoginController(
      ...
      vm.avatarFile = {
        ...
        uploadProgress: 0,
        maxFileSize:
          Umbraco.Sys.ServerVariables.umbracoSettings.maxFileSize + "KB",
        acceptedFileTypes: mediaHelper.formatFileTypes(
          Umbraco.Sys.ServerVariables.umbracoSettings.imageFileTypes
        ),
        uploaded: false,
      };
      vm.allowPasswordReset =
        Umbraco.Sys.ServerVariables.umbracoSettings.canSendRequiredEmail &&
        Umbraco.Sys.ServerVariables.umbracoSettings.allowPasswordReset;
      vm.errorMsg = "";
      vm.externalLoginFormAction =
        Umbraco.Sys.ServerVariables.umbracoUrls.externalLoginsUrl;
      ...
      vm.backgroundImage =
        Umbraco.Sys.ServerVariables.umbracoSettings.loginBackgroundImage;
      vm.usernameIsEmail =
        Umbraco.Sys.ServerVariables.umbracoSettings.usernameIsEmail;
      vm.$onInit = onInit;
      ...
      localizationService
        .localizeMany([
          ...
          vm.usernameIsEmail
            ? "placeholders_emptyEmail"
            : "placeholders_emptyUsername",
      ...
      function onInit() {
        ...
        if (inviteVal && (inviteVal === "1" || inviteVal === "2")) {
          $q.all([
            ...
            authResource.getCurrentInvitedUser().then(
              function (data) {
                vm.invitedUser = data;
              },
              function () {
            ...
            authResource.getMembershipProviderConfig().then(function (data) {
              ...
              localizationService
                .localize("errorHandling_errorInPasswordFormat", [
                  vm.invitedUserPasswordModel.passwordPolicies
                    .minPasswordLength,
                  vm.invitedUserPasswordModel.passwordPolicies
                    .minNonAlphaNumericChars,
                ])
                .then(function (data) {
      ...
      function inviteSavePassword() {
        if (
          ...
          currentUserResource
            .performSetInvitedUserPassword(vm.invitedUserPasswordModel.password)
            .then(
              function (data) {
                //success
      ...
      function loginSubmit() {
        if (
          ...
          userService.authenticate(vm.login, vm.password).then(
            function (data) {
              loginSuccess();
            },
            function (reason) {
      ...
      function requestPasswordResetSubmit(email) {
        ...
        vm.errorMsg = "";
        authResource.performRequestPasswordReset(email).then(
          function () {
        ...
        vm.requestPasswordResetForm.email.$viewChangeListeners.push(
          function () {
      ...
      function setPasswordSubmit(password, confirmPassword) {
        ...
        authResource
          .performSetPassword(
            vm.resetPasswordCodeInfo.resetCodeModel.userId,
            password,
            confirmPassword,
            vm.resetPasswordCodeInfo.resetCodeModel.resetCode
          )
          .then(
            function () {
        ...
        vm.setPasswordForm.confirmPassword.$viewChangeListeners.push(
          function () {
      ...
      function setGreeting() {
        var date = new Date();
        localizationService
          .localize("login_greeting" + date.getDay())
          .then(function (label) {
      ...
      function upload(file) {
        ...
        Upload.upload({
          url: umbRequestHelper.getApiUrl(
            ...
            if (status === 404) {
              ...
              if (evt.InnerException) {
                vm.avatarFile.serverErrorMessage =
                  evt.InnerException.ExceptionMessage;
                //Check if its the common "too large file" exception
                if (
                  evt.InnerException.StackTrace &&
                  evt.InnerException.StackTrace.indexOf(
  ...
  function umbNavigationDirective() {
    return {
      ...
      // replace the html element with the template
      template:
        '<div id="leftcolumn" ng-controller="Umbraco.NavigationController" ng-mouseleave="leaveTree($event)" ng-mouseenter="enterTree($event)" on-outside-click="onOutsideClick()">  <div id="navigation" ng-show="showNavigation" class="fill umb-modalcolumn" ng-animate="\'slide\'" nav-resize ng-class="{\'--notInFront\': infiniteMode}"> <div class="navigation-inner-container"> <div class="umb-language-picker" ng-if="currentSection === \'content\' && languages.length > 1" deep-blur="page.languageSelectorIsOpen = false" on-outside-click="page.languageSelectorIsOpen = false"> <button type="button" class="umb-language-picker__toggle" ng-click="toggleLanguageSelector()" aria-haspopup="true" aria-expanded="{{page.languageSelectorIsOpen}}"> <span> <span class="sr-only"> <localize key="visuallyHiddenTexts_currentLanguage">Current language</localize> <span>: </span> </span> <span>{{selectedLanguage.name}}</span> </span> <umb-icon icon="{{page.languageSelectorIsOpen ? \'icon-navigation-up\' : \'icon-navigation-down\'}}" class="umb-language-picker__expand icon-navigation-down" aria-hidden="true">&nbsp;</umb-icon> </button> <div class="umb-language-picker__dropdown" ng-if="page.languageSelectorIsOpen"> <button type="button" class="umb-language-picker__dropdown-item" ng-class="{\'umb-language-picker__dropdown-item--current\': language.active}" ng-click="selectLanguage(language)" ng-repeat="language in languages"> <span class="sr-only"> <localize key="visuallyHiddenTexts_switchLanguage">Switch language to</localize> <span>: </span> </span> <span>{{language.name}}</span> </button> </div> </div>  <div id="tree" ng-show="authenticated"> <umb-tree api="treeApi" on-init="onTreeInit()"> </umb-tree> </div> </div> <div class="offset6" id="navOffset" style="z-index: 10"> <umb-context-menu ng-if="showContextMenu" menu-dialog-title="{{menuDialogTitle}}" current-section="{{currentSection}}" current-node="menuNode" menu-actions="menuActions"> </umb-context-menu> <umb-context-dialog ng-if="showContextMenuDialog" dialog-title="menuDialogTitle" current-node="menuNode" view="dialogTemplateUrl"> </umb-context-dialog> </div> <div class="umb-editor__overlay"></div> </div> </div> ',
    };
  }
  angular
    .module("umbraco.directives")
    .directive("umbNavigation", umbNavigationDirective);
  ("use strict");
  (function () {
    "use strict";
    ...
    function UmbPasswordTipController(localizationService) {
      var defaultMinPwdLength =
        Umbraco.Sys.ServerVariables.umbracoSettings.minimumPasswordLength;
      var defaultMinPwdNonAlphaNum =
        Umbraco.Sys.ServerVariables.umbracoSettings.minimumPasswordNonAlphaNum;
      var vm = this;
      vm.$onInit = onInit;
      ...
      function onInit() {
        ...
        if (vm.minPwdNonAlphaNum > 0) {
          localizationService
            .localize("user_newPasswordFormatNonAlphaTip", [
      ...
      var updatePasswordTip = function updatePasswordTip(passwordLength) {
        ...
        if (remainingLength > 0) {
          localizationService
            .localize("user_newPasswordFormatLengthTip", [remainingLength])
            .then(function (data) {
              vm.passwordTip = data;
      ...
      function handleKeyDown(event) {
        ...
        if (vm.hasResults && (event.keyCode === 38 || event.keyCode === 40)) {
          ...
          if (vm.activeResultGroup === null) {
            ...
            vm.activeResultGroup = down
              ? _.first(allGroups)
              : _.last(allGroups);
            vm.activeResult = down
              ? _.first(vm.activeResultGroup.results)
              : _.last(vm.activeResultGroup.results);
          } else if (down) {
            ...
            if (vm.activeResult === _.last(vm.activeResultGroup.results)) {
              if (vm.activeResultGroup === _.last(allGroups)) {
                ...
                vm.activeResultGroup =
                  allGroups[allGroups.indexOf(vm.activeResultGroup) + 1];
              }
              vm.activeResult = _.first(vm.activeResultGroup.results);
            } else {
              vm.activeResult =
                vm.activeResultGroup.results[
                  vm.activeResultGroup.results.indexOf(vm.activeResult) + 1
                ];
            }
          } else {
          ...
          $timeout(function () {
            var resultElementLink = $(
              ".umb-search-item[active-result='true'] .umb-search-result__link"
            );
      ...
      link: function link(scope, element, attr, ctrl) {
        ...
        function calculateWidth() {
          $timeout(function () {
            ...
            var containerWidth =
              $(".umb-app-header").outerWidth() -
              $(".umb-app-header__actions").outerWidth();
            var trayToggleWidth = $(
              "#applications .sections li.expand"
            ).outerWidth();
            var sectionsWidth = 0;
        ...
        scope.sectionClick = function (event, section) {
          ...
          if (section.routePath) {
            ...
            var lastAccessed = historyService.getLastAccessedItemForSection(
              section.alias
            );
        ...
        scope.currentSectionInOverflow = function () {
          ...
          return (
            ...
            scope.sections.indexOf(currentSection[0]) >
              scope.visibleSections - 1
          );
        };
        loadSections();
      },
  ...
  angular
    .module("umbraco.directives")
    .directive("umbSections", sectionsDirective);
  ("use strict");
  /**
@ngdoc directive
  ...
  (function () {
    ...
    function TourDirective($timeout, $http, $q, tourService, backdropService) {
      function link(scope, el, attr, ctrl) {
        ...
        function nextStep() {
          ...
          if (scope.model.currentStepIndex !== scope.model.steps.length) {
            ...
            if (upcomingStep.skipStepIfVisible) {
              var tryFindDomEl = document.querySelector(
                upcomingStep.skipStepIfVisible
              );
              if (tryFindDomEl) {
                // check if element is visible:
                if (
                  tryFindDomEl.offsetWidth ||
                  tryFindDomEl.offsetHeight ||
                  tryFindDomEl.getClientRects().length
                ) {
        ...
        function startStep() {
          scope.loadingStep = true;
          backdropService.setOpacity(
            scope.model.steps[scope.model.currentStepIndex].backdropOpacity
          );
          backdropService.setHighlight(null);
          waitForPendingRerequests().then(function () {
            scope.model.currentStep =
              scope.model.steps[scope.model.currentStepIndex];
            setView();
        ...
        function findHighlightElement() {
          ...
          $timeout(function () {
            ...
            if (
              scope.model.currentStep &&
              scope.model.currentStep.type === "intro"
            ) {
            ...
            var scrollToCenterOfContainer =
              offsetTop - scrollParent[0].clientHeight / 2;
            ...
            if (offsetTop > scrollParent[0].clientHeight - 200) {
              scrollParent.animate(
                ...
                function () {
                  ...
                  setPulsePosition();
                  backdropService.setHighlight(
                    scope.model.currentStep.element,
                    scope.model.currentStep.elementPreventClick
                  );
                }
              );
            } else {
        ...
        function setPulsePosition() {
          if (scope.model.currentStep.event) {
            pulseTimer = $timeout(function () {
              var clickElementSelector = scope.model.currentStep.eventElement
                ? scope.model.currentStep.eventElement
                : scope.model.currentStep.element;
          ...
          var timer = window.setInterval(function () {
            ...
            if (
              document.querySelectorAll(
                ".ng-enter, .ng-leave, .umb-editor--animating"
              ).length === 0
            ) {
              animationsDone = true;
            }
  ...
  (function () {
    ...
    function TourStepDirective() {
      ...
      var directive = {
        ...
        transclude: true,
        template:
          '<div class="umb-tour-step umb-tour-step--{{size}}"> <div ng-if="hideClose !== true"> <button type="button" class="umb-tour-step__close" hotkey="esc" ng-click="close()"> <umb-icon icon="icon-wrong" class="icon-wrong"></umb-icon> <span class="sr-only"> <localize key="general_close">Close</localize> </span> </button> </div> <div ng-transclude></div> </div> ',
        scope: {
          size: "@?",
          onClose: "&?",
          hideClose: "=?",
    ...
    angular
      .module("umbraco.directives")
      .directive("umbTourStep", TourStepDirective);
  })();
  ("use strict");
  /**
@ngdoc directive
  ...
  (function () {
    ...
    function TourStepContentDirective() {
      var directive = {
        ...
        transclude: true,
        template:
          '<div class="umb-tour-step__content"> <div ng-bind-html="content"></div> <div ng-transclude></div> </div>',
        scope: { content: "=" },
      };
      return directive;
    }
    angular
      .module("umbraco.directives")
      .directive("umbTourStepContent", TourStepContentDirective);
  })();
  ("use strict");
  /**
@ngdoc directive
...
**/
  (function () {
    ...
    angular
      .module("umbraco.directives")
      .directive("umbTourStepCounter", TourStepCounterDirective);
  })();
  ("use strict");
  /**
@ngdoc directive
...
**/
  (function () {
    ...
    angular
      .module("umbraco.directives")
      .directive("umbTourStepFooter", TourStepFooterDirective);
  })();
  ("use strict");
  /**
@ngdoc directive
  ...
  (function () {
    ...
    function TourStepHeaderDirective() {
      var directive = {
        ...
        transclude: true,
        template:
          '<div class="umb-tour-step__header"> <div class="umb-tour-step__title">{{title}}</div> <div ng-transclude></div> </div>',
        scope: { title: "=" },
      };
      return directive;
    }
    angular
      .module("umbraco.directives")
      .directive("umbTourStepHeader", TourStepHeaderDirective);
  })();
  ("use strict");
  /**
@ngdoc directive
    ...
    function UmbButtonController($timeout, localizationService) {
      ...
      function onChanges(changes) {
        ...
        if (changes.state) {
          ...
          if (
            changes.state.currentValue === "success" ||
            changes.state.currentValue === "error"
          ) {
...
**/
  (function () {
    ...
    var component = {
      template:
        '<button type="button" data-element="{{vm.element}}" class="btn-reset umb-button-ellipsis {{vm.cssClass}}" style="color:{{vm.color}};" ng-class="{\'umb-button-ellipsis--hidden\': vm.state === \'hidden\', \'show-text\': vm.showText, \'umb-button-ellipsis--tab\' : vm.mode === \'tab\', \'umb-button-ellipsis--small\' : vm.mode === \'small\'}" ng-click="vm.clickButton($event)"> <span class="umb-button-ellipsis__content"> <span class="umb-button-ellipsis__icon" aria-hidden="true">&bull;&bull;&bull;</span> <span class="umb-button-ellipsis__text" ng-class="{\'sr-only\': vm.showText !== true}">{{vm.text}}</span> </span> </button> ',
...
**/
  (function () {
    ...
    angular
      .module("umbraco.directives")
      .directive("umbButtonGroup", ButtonGroupDirective);
  })();
  ("use strict");
  /**
@ngdoc directive
...
**/
  (function () {
    ...
    function ToggleDirective(localizationService, eventsService, $timeout) {
      function link(scope, el, attr, ctrl) {
        ...
        function setLabelText() {
          ...
          if (
            scope.displayLabelOn.length === 0 &&
            scope.displayLabelOff.length === 0
          ) {
            var labelKeys = ["general_on", "general_off"];
    ...
    angular
      .module("umbraco.directives")
      .directive("umbToggle", ToggleDirective);
  })();
  ("use strict");
  /**
@ngdoc directive
...
**/
  (function () {
    ...
    function ToggleGroupDirective() {
      function link(scope, el, attr, ctrl) {
        for (var i = 0; i < scope.items.length; i++) {
          scope.items[i].inputId =
            "umb-toggle-group-item_" + String.CreateGuid();
        }
    ...
    angular
      .module("umbraco.directives")
      .directive("umbToggleGroup", ToggleGroupDirective);
  })();
  ("use strict");
  (function () {
    "use strict";
    function ContentEditController(
      $rootScope,
      $scope,
      $routeParams,
      $q,
      ...
      var evts = [];
      var infiniteMode =
        $scope.infiniteModel && $scope.infiniteModel.infiniteMode;
      ...
      $scope.page.menu.currentSection =
        appState.getSectionState("currentSection");
      $scope.page.listViewPath = null;
      $scope.page.isNew = $scope.isNew ? true : false;
      if (infiniteMode) {
        $scope.page.allowInfinitePublishAndClose =
          $scope.infiniteModel.allowPublishAndClose;
        $scope.page.allowInfiniteSaveAndClose =
      ...
      function init() {
        ...
        if (
          content.id &&
          content.isChildOfListView &&
          content.trashed === false
        ) {
          $scope.page.listViewPath =
      ...
      function loadBreadcrumb() {
        ...
        var id = $scope.page.isNew
          ? $scope.content.parentId
          : $scope.content.id;
        if (!id) {
          return;
        }
        entityResource
          .getAncestors(id, "document", $scope.culture)
          .then(function (anc) {
            $scope.ancestors = anc;
          });
      }
      ...
      function bindEvents() {
        ...
        evts.push(
          eventsService.on("editors.documentType.saved", function (name, args) {
            // if this content item uses the updated doc type we need to reload the content item
            if (
              args &&
              args.documentType &&
              $scope.content.documentType.id === args.documentType.id
            ) {
              reload();
            }
          })
        ...
        evts.push(
          eventsService.on("editors.content.reload", function (name, args) {
        ...
        evts.push(
          eventsService.on("rte.file.uploading", function () {
            $scope.page.saveButtonState = "busy";
            $scope.page.buttonGroupState = "busy";
          })
        );
        evts.push(
          eventsService.on("rte.file.uploaded", function () {
            $scope.page.saveButtonState = "success";
            $scope.page.buttonGroupState = "success";
          })
        );
        evts.push(
          eventsService.on("rte.shortcut.save", function () {
        ...
        evts.push(
          eventsService.on("content.saved", function () {
      ...
      function appendRuntimeData() {
        $scope.content.variants.forEach(function (variant) {
          variant.compositeId =
            contentEditingHelper.buildCompositeVariantId(variant);
      ...
      function createButtons(content) {
        ...
        if (
          $scope.page.isNew &&
          $location.path().search(/contentBlueprints/i) !== -1
        ) {
          isBlueprint = true;
        }
        // for trashed and element type items, the save button is the primary action - otherwise it's a secondary action
        $scope.page.saveButtonStyle =
          content.trashed || content.isElement || isBlueprint
            ? "primary"
            : "info";
        ...
        if (
          $scope.activeApp &&
          !contentAppHelper.isContentBasedApp($scope.activeApp)
        ) {
          $scope.defaultButton = null;
        ...
        if (_.contains($scope.content.allowedActions, "A")) {
          ...
          $scope.page.saveButtonEllipsis =
            content.variants && content.variants.length > 1 ? "true" : "false";
        } else {
          $scope.page.showSaveButton = false;
        }
        ...
        if (!$scope.content.isChildOfListView) {
          navigationService
            ...
            .then(
              ...
              function () {
                ...
                console.log(
                  "A problem occurred syncing the tree! A path is probably incorrect."
                );
              }
            );
          ...
          umbRequestHelper
            .resourcePromise(
              ...
              "Failed to retrieve data for child node " + content.id
            )
            .then(function (node) {
      ...
      function checkValidility() {
        ...
        allControls = _.filter(allControls, function (obj) {
          return (
            obj.$name !== "contentHeaderForm" &&
            obj.$name !== "tabbedContentForm" &&
            obj.hasOwnProperty("$submitted")
          );
        });
        for (var i = 0; i < allControls.length; i++) {
          ...
          childFieldsToMarkAsValid = recurseFormControls(
            nestedFormControls,
      ...
      function performSave(args) {
        ...
        return contentEditingHelper
          .contentEditorPerformSave({
        ...
        if (
          ...
          var dialog = {
            ...
            submit: function submit(model) {
              ...
              //ignore invariant
              var culturesForUnpublishing = _.map(
                selectedVariants,
                function (v) {
              ...
              contentResource
                .unpublish($scope.content.id, culturesForUnpublishing)
                .then(
                  function (data) {
                    formHelper.resetForm({ scope: $scope });
                    contentEditingHelper.reBindChangedProperties(
                      $scope.content,
                      data
                    );
                    init();
                    ...
                    $scope.page.buttonGroupState = "success";
                    eventsService.emit("content.unpublished", {
                      content: $scope.content,
                    });
                    overlayService.close();
                  },
              ...
              return performSave({
                ...
                function (err) {
                  ...
                  if (
                    ...
                    err.data &&
                    err.data.ModelState &&
                    Object.keys(err.data.ModelState).length > 0
                  ) {
      ...
      $scope.schedule = function () {
        ...
        if (
          ...
          var dialog = {
            ...
            submit: function submit(model) {
              for (var i = 0; i < $scope.content.variants.length; i++) {
                $scope.content.variants[i].releaseDate =
                  model.variants[i].releaseDate;
                $scope.content.variants[i].expireDate =
                  model.variants[i].expireDate;
                $scope.content.variants[i].releaseDateFormatted =
                  model.variants[i].releaseDateFormatted;
                $scope.content.variants[i].expireDateFormatted =
                  model.variants[i].expireDateFormatted;
            ...
            submit: function submit(model) {
              ...
              return performSave({
                saveMethod: function saveMethod(
                  ...
                  return contentResource.publishWithDescendants(
                    content,
                    create,
                    model.includeUnpublished,
                    files,
                    showNotifications
                  );
                },
    ...
    angular
      .module("umbraco.directives")
      .controller(
        "Umbraco.Editors.Content.EditorDirectiveController",
        ContentEditController
      );
    angular
      .module("umbraco.directives")
      .directive("contentEditor", createDirective);
  })();
  ("use strict");
  ...
  (function () {
    "use strict";
    function ContentNodeInfoDirective(
      $timeout,
      logResource,
      eventsService,
      userService,
      ...
      function link(scope) {
        ...
        scope.disableTemplates =
          Umbraco.Sys.ServerVariables.features.disabledFeatures.disableTemplates;
        scope.allowChangeDocumentType = false;
        scope.allowChangeTemplate = false;
        scope.allTemplates = [];
        scope.historyLabelKey =
          scope.node.variants && scope.node.variants.length === 1
            ? "general_history"
        ...
        function onInit() {
          ...
          scope.isInfiniteMode =
            editorService.getNumberOfEditors() > 0 ? true : false;
          userService.getCurrentUser().then(function (user) {
            // only allow change of media type if user has access to the settings sections
            var hasAccessToSettings =
              user.allowedSections.indexOf("settings") !== -1 ? true : false;
          ...
          if (scope.documentType !== null) {
            scope.previewOpenUrl =
              "#/settings/documenttypes/edit/" + scope.documentType.id;
          }
          ...
          scope.disableTemplates =
            scope.disableTemplates || scope.node.isElement;
        }
        ...
        scope.openTemplate = function () {
          var template = _.findWhere(scope.allTemplates, {
            alias: scope.node.template,
          });
          if (!template) {
            return;
          }
        ...
        function loadAuditTrail(forceReload) {
          ...
          logResource
            .getPagedEntityLog(scope.auditTrailOptions)
            .then(function (data) {
              // get current backoffice user and format dates
              userService.getCurrentUser().then(function (currentUser) {
                angular.forEach(data.items, function (item) {
                  item.timestampFormatted = dateHelper.getLocalDate(
                    item.timestamp,
                    currentUser.locale,
                    "LLL"
                  );
        ...
        function loadRedirectUrls() {
          ...
          redirectUrlsResource.getEnableState().then(function (response) {
            ...
            if (scope.urlTrackerDisabled === false) {
              redirectUrlsResource
                .getRedirectsForContentItem(scope.node.udi)
                .then(function (data) {
                  scope.redirectUrls = data.searchResults;
                  scope.hasRedirects =
                    typeof data.searchResults !== "undefined" &&
        ...
        function formatDatesToLocal() {
          // get current backoffice user and format dates
          userService.getCurrentUser().then(function (currentUser) {
            scope.currentVariant.createDateFormatted = dateHelper.getLocalDate(
              scope.currentVariant.createDate,
              currentUser.locale,
              "LLL"
            );
            scope.currentVariant.releaseDateFormatted = dateHelper.getLocalDate(
              scope.currentVariant.releaseDate,
              currentUser.locale,
              "LLL"
            );
            scope.currentVariant.expireDateFormatted = dateHelper.getLocalDate(
              scope.currentVariant.expireDate,
              currentUser.locale,
              "LLL"
            );
          });
        ...
        function updateCurrentUrls() {
          ...
          scope.currentUrls = _.filter(scope.node.urls, function (url) {
            return (
              scope.currentVariant.language == null ||
              scope.currentVariant.language.culture === url.culture
            );
          });
          // figure out if multiple cultures apply across the content URLs
          scope.currentUrlsHaveMultipleCultures =
            _.keys(
              _.groupBy(scope.currentUrls, function (url) {
                return url.culture;
              })
            ).length > 1;
        }
    ...
    angular
      .module("umbraco.directives")
      .directive("umbContentNodeInfo", ContentNodeInfoDirective);
  })();
  ("use strict");
  (function () {
    "use strict";
    ...
    function tabbedContentDirective($timeout) {
      function link($scope, $element) {
        ...
        function onScroll(event) {
          var viewFocusY =
            scrollableNode.scrollTop + scrollableNode.clientHeight * 0.5;
          for (var i in $scope.content.tabs) {
            var group = $scope.content.tabs[i];
            var node = propertyGroupNodesDictionary[group.id];
            if (
              viewFocusY >= node.offsetTop &&
              viewFocusY <= node.offsetTop + node.clientHeight
            ) {
        ...
        function scrollTo(id) {
          ...
          if (getScrollPositionFor !== null) {
            ...
            $scope.scrollTween = anime({
              ...
              duration:
                200 +
                Math.min((Math.abs(to - from) / viewportHeight) * 100, 400),
      ...
      function controller($scope) {
        ...
        if ($scope.contentNodeModel) {
          $scope.defaultVariant = _.find(
            $scope.contentNodeModel.variants,
            function (variant) {
              // defaultVariant will never have segment. Wether it has a language or not depends on the setup.
              return (
                !variant.segment &&
                ((variant.language && variant.language.isDefault) ||
                  !variant.language)
              );
            }
          );
        ...
        $scope.propertyEditorDisabled = function (property) {
          ...
          var canEditCulture =
            !contentLanguage || // If the property culture equals the content culture it can be edited
    ...
    angular
      .module("umbraco.directives")
      .directive("umbTabbedContent", tabbedContentDirective);
  })();
  ("use strict");
  (function () {
    "use strict";
    ...
    function umbVariantContentController($scope, contentAppHelper) {
      ...
      function onAppChanged(activeApp) {
        ...
        vm.nameDisabled =
          activeApp && !contentAppHelper.isContentBasedApp(activeApp);
      }
      /**
       * Used to proxy a callback
       * @param {any} item
    ...
    angular
      .module("umbraco.directives")
      .component("umbVariantContent", umbVariantContent);
  })();
  ("use strict");
  (function () {
    "use strict";
    ...
    function umbVariantContentEditorsController(
      $scope,
      $location,
      eventsService
    ) {
      ...
      function onChanges(changes) {
        if (
          changes.culture &&
          !changes.culture.isFirstChange() &&
          changes.culture.currentValue !== changes.culture.previousValue
        ) {
          setActiveVariant();
        } else if (
          changes.segment &&
          !changes.segment.isFirstChange() &&
      ...
      function splitViewChanged() {
        //send an event downwards
        $scope.$broadcast("editors.content.splitViewChanged", {
          editors: vm.editors,
        });
      }
      /**
      ...
      function setActiveVariant() {
          ...
          for (var s = 1; s < vm.editors.length; s++) {
            ...
            var variant = vm.content.variants.find(function (v) {
              return (
                ...
                v.segment === vm.editors[s].content.segment
              );
            });
        ...
        if (vm.content.variants.length > 1) {
          eventsService.emit(
            "editors.content.cultureChanged",
      ...
      function insertVariantEditor(index, variant) {
        ...
        variant.active = true;
        var variantCulture = variant.language
          ? variant.language.culture
          : "invariant";
        var variantSegment = variant.segment;
        var currentCulture =
          index < vm.editors.length ? vm.editors[index].culture : null;
        var currentSegment =
        ...
        if (
          index >= vm.editors.length ||
          currentCulture !== variantCulture ||
          currentSegment !== variantSegment
        ) {
      ...
      function requestSplitView(args) {
        ...
        var variant = vm.content.variants.find(function (v) {
          return (
            (!v.language || v.language.culture === culture) &&
            v.segment === segment
          );
        });
        if (variant != null) {
      ...
      var unbindSplitViewRequest = eventsService.on(
        "editors.content.splitViewRequest",
        function (_, args) {
      ...
      function closeSplitView(editorIndex) {
        ...
        var culture = vm.editors[0].content.language
          ? vm.editors[0].content.language.culture
          : null;
        $location.search({
          cculture: culture,
      ...
      function selectVariant(variant, editorIndex) {
        ...
        if (
          vm.editors.find(function (editor) {
            return (
              (!editor.content.language ||
                editor.content.language.culture === variantCulture) &&
              editor.content.segment === variantSegment
            );
          })
        ) {
          return;
        ...
        if (editorIndex === 0) {
          ...
          $location
            .search("cculture", variantCulture)
            .search("csegment", variantSegment);
        } else {
    ...
    angular
      .module("umbraco.directives")
      .component("umbVariantContentEditors", umbVariantContentEditors);
  })();
  ("use strict");
  (function () {
    "use strict";
    ...
    var umbNotificationListComponent = {
      template:
        ' <span class="db" ng-repeat="notification in vm.notifications">   <span class="db umb-list-item__description" ng-class="{\'text-success\': notification.type === 3, \'text-error\': notification.type === 2 || notification.type === 4}"> {{notification.message}} </span> </span> ',
  ...
  (function () {
    ...
    function EditorSubHeaderDirective() {
      var directive = {
        ...
        scope: { appearance: "@?" },
        template:
          '<div class="umb-editor-sub-header umb-editor-sub-header--{{appearance}}" umb-sticky-bar ng-transclude> </div> ',
      };
      return directive;
    }
    angular
      .module("umbraco.directives")
      .directive("umbEditorSubHeader", EditorSubHeaderDirective);
  })();
  ("use strict");
  /**
@ngdoc directive
  ...
  (function () {
    ...
    angular
      ...
      .directive(
        ...
        EditorSubHeaderContentLeftDirective
      );
  })();
  ("use strict");
  /**
  ...
  (function () {
    ...
    angular
      ...
      .directive(
        ...
        EditorSubHeaderContentRightDirective
      );
  })();
  ("use strict");
  /**
...
**/
  (function () {
    ...
    angular
      .module("umbraco.directives")
      .directive("umbEditorSubHeaderSection", EditorSubHeaderSectionDirective);
  })();
  ("use strict");
  /**
@ngdoc directive
...
**/
  (function () {
    ...
    angular
      .module("umbraco.directives")
      .directive("umbBreadcrumbs", BreadcrumbsDirective);
  })();
  ("use strict");
  (function () {
    "use strict";
    function EditorDirective() {
      var directive = {
        ...
        replace: true,
        template:
          '<div class="umb-editor" ng-style="model.style" ng-class="{\'umb-editor--small\': model.size === \'small\', \'umb-editor--animating\': model.animating}"> <div ng-if="!model.view && !model.animating" ng-transclude></div> <div ng-if="model.view && !model.animating" ng-include="model.view"></div> <div ng-if="model.showOverlay" class="umb-editor__overlay"></div> </div>',
        scope: { model: "=" },
      };
      return directive;
    }
    angular
      .module("umbraco.directives")
      .directive("umbEditor", EditorDirective);
  })();
  ("use strict");
  /**
@ngdoc directive
  ...
  (function () {
    ...
    function EditorContainerDirective(overlayHelper) {
      ...
      var directive = {
        ...
        replace: true,
        template:
          ' <div data-element="editor-container" class="umb-editor-container umb-panel-body umb-scrollable row-fluid" ng-class="{\'-stop-scrolling\': numberOfOverlays > 0}">  <div> <umb-overlay-backdrop></umb-overlay-backdrop> </div> <div class="umb-pane"> <div ng-transclude></div> </div> </div> ',
        link: link,
      };
      return directive;
    }
    angular
      .module("umbraco.directives")
      .directive("umbEditorContainer", EditorContainerDirective);
  })();
  ("use strict");
  (function () {
    "use strict";
    function EditorContentHeader(
      ...
      function link(scope) {
        ...
        function onVariantValidation(
          ...
          if (
            errors.findIndex(function (error) {
        ...
        function onInit() {
          ...
          if (scope.vm.hasCulture) {
            scope.content.variants.forEach(function (v) {
              if (v.language !== null && v.segment === null) {
                var subVariants = scope.content.variants
                  .filter(function (subVariant) {
                    return (
                      subVariant.language.culture === v.language.culture &&
                      subVariant.segment !== null
                    );
                  })
                ...
                var variantMenuEntry = {
                  ...
                  open:
                    v.language && v.language.culture === scope.editor.culture,
                  variant: v,
          ...
          scope.content.variants.forEach(function (variant) {
            ...
            unsubscribe.push(
              serverValidationManager.subscribe(
                null,
                variant.language !== null ? variant.language.culture : null,
                null,
                onVariantValidation,
                variant.segment
              )
        ...
        scope.variantHasError = function (variant) {
          if (
            scope.vm.variantsWithError.find(function (item) {
              return (
                (!variant.language ||
                  item.culture === variant.language.culture) &&
                item.segment === variant.segment
              );
            }) !== undefined
          ) {
            return true;
    ...
    angular
      .module("umbraco.directives")
      .directive("umbEditorContentHeader", EditorContentHeader);
  })();
  ("use strict");
  /**
@ngdoc directive
  ...
  (function () {
    ...
    function EditorFooterDirective() {
      var directive = {
        ...
        replace: true,
        template:
          ' <div data-element="editor-footer" class="umb-editor-footer"> <div class="umb-editor-footer-content" ng-transclude></div> </div> ',
      };
      return directive;
    }
    angular
      .module("umbraco.directives")
      .directive("umbEditorFooter", EditorFooterDirective);
  })();
  ("use strict");
  /**
@ngdoc directive
  ...
  (function () {
    ...
    angular
      ...
      .directive(
        ...
        EditorFooterContentLeftDirective
      );
  })();
  ("use strict");
  /**
  ...
  (function () {
    ...
    angular
      ...
      .directive(
        ...
        EditorFooterContentRightDirective
      );
  })();
  ("use strict");
  /**
...
**/
  (function () {
    "use strict";
    function EditorHeaderDirective(
      editorService,
      localizationService,
      editorState,
      $rootScope
      ...
      function link(scope, $injector) {
        ...
        function setAccessibilityForName() {
          ...
          if (setTitle) {
            setAccessibilityHeaderDirective(
              false,
              scope.editorfor,
              scope.nameLocked,
              scope.name,
        ...
        function setAccessibilityHeaderDirective(
          isNew,
          editorFor,
          nameLocked,
          entityName,
          ...
          localizationService.localizeMany(localizeVars).then(function (data) {
            if (nameLocked) {
              ...
              if (!isNew) {
                ...
                if (name !== "") {
                  ...
                  scope.accessibility.a11yName =
                    name + " " + scope.accessibility.a11yName;
                  title += " " + name;
                }
              }
            ...
            scope.accessibility.a11yNameVisible = !isNullOrWhitespace(
              scope.accessibility.a11yName
            );
          });
        }
        ...
        var unbindEventHandler = $rootScope.$on(
          "$setAccessibleHeader",
          function (
            event,
            isNew,
    ...
    angular
      .module("umbraco.directives")
      .directive("umbEditorHeader", EditorHeaderDirective);
  })();
  ("use strict");
  (function () {
    "use strict";
    function EditorMenuDirective(
      ...
      function link(scope, el, attr, ctrl) {
        ...
        function getOptions() {
          ...
          if (!scope.actions) {
            treeService
              .getMenu({ treeNode: scope.currentNode })
              .then(function (data) {
    ...
    angular
      .module("umbraco.directives")
      .directive("umbEditorMenu", EditorMenuDirective);
  })();
  ("use strict");
  (function () {
    "use strict";
    ...
    angular
      ...
      .directive("umbEditorNavigation", EditorNavigationDirective);
  })();
  ("use strict");
  (function () {
    "use strict";
    function UmbEditorNavigationItemController($scope, $element, $attrs) {
      ...
      vm.clicked = function () {
        vm.expanded =
          vm.item.anchors && vm.item.anchors.length > 1 && !vm.expanded;
    ...
    angular
      ...
      .component("umbEditorNavigationItem", {
        template:
          '<button data-element="sub-view-{{vm.item.alias}}" type="button" ng-click="vm.clicked()" hotkey="{{::vm.hotkey}}" hotkey-when-hidden="true" ng-class="{\'is-active\': vm.item.active, \'-has-error\': vm.item.hasError }" ng-disabled="vm.item.disabled" class="umb-sub-views-nav-item__action umb-outline umb-outline--thin" aria-haspopup="{{ vm.item.anchors && vm.item.anchors.length > 1 }}" aria-expanded="{{ vm.expanded }}"> <i class="icon {{ vm.item.icon }}" aria-hidden="true"></i> <span class="umb-sub-views-nav-item-text">{{ vm.item.name }}</span> <div ng-show="vm.item.badge" class="badge -type-{{vm.item.badge.type}}">{{vm.item.badge.count}}</div> <div ng-show="!vm.item.badge" class="badge -type-alert --error-badge">!</div> </button> <umb-dropdown on-close="vm.close()" deep-blur="vm.close()" umb-keyboard-list class="umb-sub-views-nav-item__anchor_dropdown" ng-class="{\'is-expanded\': vm.expanded}" ng-if="vm.item.anchors && vm.item.anchors.length > 1"> <umb-dropdown-item ng-repeat="anchor in vm.item.anchors" ng-class="{\'is-active\': vm.item.active && anchor.active}"> <a href="#group-{{anchor.id}}" ng-click="vm.anchorClicked(anchor, $event)" prevent-default> <span class="sr-only"><localize key="visuallyHiddenTexts_jumpTo">Jump to</localize></span> {{anchor.label}} <span class="sr-only"><localize key="visuallyHiddenTexts_group"> group</localize></span> </a> </umb-dropdown-item> </umb-dropdown> ',
  ...
  (function () {
    ...
    function EditorRepeaterDirective(
      $http,
      $templateCache,
      $compile,
      angularHelper
      ...
      function link(scope, el) {
        ...
        if (editor.$parentScope) {
          ...
          $http
            .get(editor.view, { cache: $templateCache })
            .then(function (response) {
              ...
              if (editor.$parentForm) {
                element.html(
                  "<ng-form name='infiniteEditorForm'>" +
                    response.data +
                    "</ng-form>"
                );
              }
              ...
              if (editor.$parentForm) {
                editor.$parentForm.$addControl(
                  templateScope.infiniteEditorForm
                );
              }
            });
        }
    ...
    angular
      .module("umbraco.directives")
      .directive("umbEditors", EditorsDirective);
    angular
      .module("umbraco.directives")
      .directive("umbEditorRepeater", EditorRepeaterDirective);
  })();
  ("use strict");
  (function () {
    "use strict";
    ...
    function EditorSubViewDirective() {
      ...
      var directive = {
        ...
        replace: true,
        template:
          '<div class="umb-editor-sub-view" ng-class="\'sub-view-\' + model.name" val-sub-view="model"> <div class="umb-editor-sub-view__content" ng-show="model.active === true" ng-include="model.view"> </div> </div> ',
        scope: {
          model: "=",
          variantContent: "=?",
          content: "=",
    ...
    angular
      .module("umbraco.directives")
      .directive("umbEditorSubView", EditorSubViewDirective);
  })();
  ("use strict");
  (function () {
    "use strict";
    ...
    function EditorSubViewsDirective() {
      ...
      var directive = {
        ...
        replace: true,
        template:
          '<div class="umb-editor-sub-views"> <div id="sub-view-{{$index}}" class="umb-editor-sub-view" ng-repeat="subView in subViews track by subView.alias" ng-class="\'sub-view-\' + subView.name" val-sub-view="subView"> <div class="umb-editor-sub-view__content" ng-show="subView.active === true" ng-include="subView.view"> </div> </div> </div> ',
        scope: {
          subViews: "=",
          model: "=",
        },
    ...
    angular
      .module("umbraco.directives")
      .directive("umbEditorSubViews", EditorSubViewsDirective);
  })();
  ("use strict");
  /**
@ngdoc directive
...
**/
  (function () {
    ...
    function EditorViewDirective() {
      ...
      var directive = {
        ...
        replace: true,
        template:
          " <div class=\"umb-panel umb-editor-wrapper\" ng-class=\"{ '-no-footer': footer === 'false' }\" ng-transclude> </div> ",
        link: link,
      };
      return directive;
    }
    angular
      .module("umbraco.directives")
      .directive("umbEditorView", EditorViewDirective);
  })();
  ("use strict");
  ...
  (function () {
    ...
    angular
      .module("umbraco.directives")
      .directive("onDelayedMouseleave", onDelayedMouseleaveDirective);
  })();
  ("use strict");
  (function () {
    "use strict";
    ...
    angular
      .module("umbraco.directives")
      .directive("onDragEnd", onDragEndDirective);
  })();
  ("use strict");
  (function () {
    "use strict";
    ...
    angular
      .module("umbraco.directives")
      .directive("onDragEnter", onDragEnterDirective);
  })();
  ("use strict");
  (function () {
    "use strict";
    function onDragLeaveDirective($timeout) {
      return function (scope, elm, attrs) {
        var f = function f(event) {
          ...
          if (
            e.x > rect.left + rect.width - 1 ||
            e.x < rect.left ||
            e.y > rect.top + rect.height - 1 ||
            e.y < rect.top
          ) {
    ...
    angular
      .module("umbraco.directives")
      .directive("onDragLeave", onDragLeaveDirective);
  })();
  ("use strict");
  (function () {
    "use strict";
    ...
    angular
      .module("umbraco.directives")
      .directive("onDragOver", onDragOverDirective);
  })();
  ("use strict");
  (function () {
    "use strict";
    ...
    angular
      .module("umbraco.directives")
      .directive("onDragStart", onDragStartDirective);
  })();
  ("use strict");
  (function () {
    "use strict";
  ...
  (function () {
    ...
    angular
      .module("umbraco.directives")
      .directive("onOutsideClick", onOutsideClickDirective);
  })();
  ("use strict");
  (function () {
    "use strict";
    ...
    angular
      .module("umbraco.directives")
      .directive("onRightClick", onRightClickDirective);
  })();
  ("use strict");
  /*
...
*/
  ...
  function hexBgColor() {
    return {
      ...
      link: function link(scope, element, attr, formCtrl) {
        ...
        if (
          attr.hexBgInline === undefined ||
          (attr.hexBgInline !== undefined && attr.hexBgInline === "true")
        ) {
          var origColor = null;
          if (attr.hexBgOrig) {
  ...
  angular
    ...
    .directive(
      "hotkey",
      function ($window, keyboardService, $log, focusService) {
        return function (scope, el, attrs) {
          var options = {};
            ...
            if (keyCombo) {
              ...
              keyboardService.bind(
                ...
                function () {
                  ...
                  if (
                    element.is(
                      "a,div,button,input[type='button'],input[type='submit'],input[type='checkbox']"
                    ) &&
                    !element.is(":disabled")
                  ) {
                    if (element.is(":visible") || attrs.hotkeyWhenHidden) {
                      ...
                      if (
                        keyCombo === "enter" &&
                        clickableElements.indexOf(activeElementType) === 0
                      ) {
    ...
    return function (scope, element, attrs) {
      ...
      if (attrs.preventDefault) {
        attrs.$observe("preventDefault", function (newVal) {
          enabled =
            newVal === "false" || newVal === 0 || newVal === false
              ? false
              : true;
        });
      }
    ...
    .directive("umbAutoResize", function ($timeout) {
      return {
        ...
        link: function link(scope, element, attr, controllersArr) {
          ...
          var unbindModelWatcher = scope.$watch(
            function () {
    ...
    function FocusLock($timeout, $rootScope, angularHelper) {
      ...
      function link(scope, element) {
        ...
        var focusableElementsSelector =
          '[role="button"], a[href]:not([disabled]):not(.ng-hide), button:not([disabled]):not(.ng-hide), textarea:not([disabled]):not(.ng-hide), input:not([disabled]):not(.ng-hide), select:not([disabled]):not(.ng-hide)';
        ...
        function getDomNodes() {
          ...
          if (infiniteEditorsWrapper) {
            infiniteEditors = Array.from(
              infiniteEditorsWrapper.querySelectorAll(".umb-editor") || []
            );
          }
        }
        ...
        function setElementFocus() {
          ...
          if (closingEditor) {
            ...
            if (infiniteEditors && infiniteEditors.length === 1) {
              ...
              var lastItemIndex =
                $rootScope.lastKnownFocusableElements.length - 1;
              lastKnownElement =
                $rootScope.lastKnownFocusableElements[lastItemIndex];
        ...
        function cleanupEventHandlers() {
          ...
          if (infiniteEditors.length > 0) {
            ...
            var inactiveEditors = infiniteEditors.filter(function (editor) {
  ...
  (function () {
    ...
    function UmbSearchFilterController($timeout, localizationService) {
      ...
      function onInit() {
        ...
        vm.preventSubmitOnEnter =
          Object.toBoolean(vm.preventSubmitOnEnter) === true;
        // If a labelKey is passed let's update the returned text if it's does not contain an opening square bracket [
        if (vm.labelKey) {
          localizationService.localize(vm.labelKey).then(function (data) {
            if (data.indexOf("[") === -1) {
    ...
    angular
      .module("umbraco.directives")
      .component("umbSearchFilter", component);
  })();
  ("use strict");
  (function () {
    "use strict";
    ...
    .directive(
      ...
      function (
        ...
        return {
          ...
          template:
            ' <div> <umb-load-indicator ng-if="isLoading"></umb-load-indicator> <div disable-hotkeys class="umb-rte" id="{{textAreaHtmlId}}" ng-style="{ visibility : isLoading ? \'hidden\' : \'visible\' }"></div> </div> ',
          replace: true,
          link: function link(scope, element, attrs) {
            ...
            if (
              !scope.configuration.maxImageSize &&
              scope.configuration.maxImageSize !== 0
            ) {
              editorConfig.maxImageSize =
                tinyMceService.defaultPrevalues().maxImageSize;
            }
            ...
            $q.all(promises).then(function (result) {
              ...
              var tabShownListener = eventsService.on(
                "app.tabChange",
                function (e, args) {
                  var tabId = args.id;
...
**/
  (function () {
    ...
    angular
      .module("umbraco.directives")
      .directive("umbBoxContent", BoxContentDirective);
  })();
  ("use strict");
  /**
@ngdoc directive
  ...
  (function () {
    ...
    function BoxHeaderDirective(localizationService) {
      var directive = {
        ...
        transclude: true,
        template:
          '<div class="umb-box-header"> <div> <div class="umb-box-header-title" ng-if="titleLabel"> {{titleLabel}} </div> <div class="umb-box-header-description" ng-if="descriptionLabel"> {{descriptionLabel}} </div> </div> <ng-transclude></ng-transclude> </div> ',
        scope: {
          titleKey: "@?",
          title: "@?",
          descriptionKey: "@?",
        ...
        link: function link(scope) {
          ...
          if (scope.titleKey) {
            localizationService
              .localize(scope.titleKey, [], scope.title)
              .then(function (data) {
          ...
          if (scope.descriptionKey) {
            localizationService
              .localize(scope.descriptionKey, [], scope.description)
              .then(function (data) {
    ...
    angular
      .module("umbraco.directives")
      .directive("umbBoxHeader", BoxHeaderDirective);
  })();
  ("use strict");
  /**
* @ngdoc directive
...
**/
      ...
      return {
        ...
        link: function link(scope, element, attr, formCtrl) {
          ...
          if (scope.label && scope.label[0] === "@") {
            localizationService
              .localize(scope.label.substring(1))
              .then(function (data) {
          ...
          if (scope.description && scope.description[0] === "@") {
            localizationService
              .localize(scope.description.substring(1))
              .then(function (data) {
  ...
  angular
    .module("umbraco.directives")
    .directive("umbImageCrop", function ($timeout, $window, cropperHelper) {
      var MAX_SCALE = 4;
      return {
        restrict: "E",
        replace: true,
        ...
        link: function link(scope, element, attrs, windowResizeListener) {
          ...
          function onScroll(event) {
            ...
            var delta = Math.max(
              -50,
              Math.min(50, event.wheelDelta || -event.detail)
            );
            if (sliderRef) {
              var currentScale = sliderRef.noUiSlider.get();
              var newScale = Math.min(
                Math.max(
                  currentScale + delta * 0.001 * scope.dimensions.image.ratio,
                  scope.dimensions.scale.min
                ),
                scope.dimensions.scale.max
              );
          ...
          var setConstraints = function setConstraints() {
            constraints.left.min =
              scope.dimensions.cropper.width - scope.dimensions.image.width;
            constraints.top.min =
              scope.dimensions.cropper.height - scope.dimensions.image.height;
          };
          var setDimensions = function setDimensions() {
            ...
            // set margins:
            scope.dimensions.margin.left =
              (scope.dimensions.viewport.width - _cropW) * 0.5;
            scope.dimensions.margin.top =
              (scope.dimensions.viewport.height - _cropH) * 0.5;
          ...
          var resizeImageToScale = function resizeImageToScale(ratio) {
            ...
            scope.dimensions.image.width =
              scope.dimensions.image.originalWidth * ratio;
            scope.dimensions.image.height =
              scope.dimensions.image.originalHeight * ratio;
            var difW = scope.dimensions.image.width - prevWidth;
            var difH = scope.dimensions.image.height - prevHeight;
            // normalized focus point:
            var focusNormX =
              (-scope.dimensions.image.left +
                scope.dimensions.cropper.width * 0.5) /
              prevWidth;
            var focusNormY =
              (-scope.dimensions.image.top +
                scope.dimensions.cropper.height * 0.5) /
              prevHeight;
            scope.dimensions.image.left =
              scope.dimensions.image.left - difW * focusNormX;
            scope.dimensions.image.top =
              scope.dimensions.image.top - difH * focusNormY;
            setConstraints();
            validatePosition(
              scope.dimensions.image.left,
              scope.dimensions.image.top
          ...
          var validatePosition = function validatePosition(left, top) {
            left = Math.min(
              Math.max(left, constraints.left.min),
              constraints.left.max
            );
            top = Math.min(
              Math.max(top, constraints.top.min),
              constraints.top.max
            );
          ...
          function calculateCropBox() {
            runtimeCrop = cropperHelper.pixelsToCoordinates(
              scope.dimensions.image,
              scope.dimensions.cropper.width,
              scope.dimensions.cropper.height,
              0
            );
          ...
          $overlay.draggable({
            ...
            drag: function drag(event, ui) {
              scope.$apply(function () {
                validatePosition(
                  dragStartPosition.left +
                    (ui.position.left - ui.originalPosition.left),
                  dragStartPosition.top +
          ...
          function setCrop() {
            ...
            if (createDefaultCrop) {
              ...
              if (scope.center) {
                ...
                var x1 = Math.min(
                  Math.max(
                    scope.center.left * scope.dimensions.image.width -
                      scope.dimensions.cropper.width / 2,
                    0
                  ),
                ...
                var y1 = Math.min(
                  Math.max(
                    scope.center.top * scope.dimensions.image.height -
                      scope.dimensions.cropper.height / 2,
                    0
                  ),
                  scope.dimensions.image.height -
                    scope.dimensions.cropper.height
          ...
          unsubscribe.push(
            scope.$watchCollection(
              "[width, height, alias, forceUpdate]",
          ...
          var throttledScale = _.throttle(function () {
  ...
  (function () {
    ...
    function umbImageGravityController($scope, $element, $timeout) {
          ...
          $timeout(function () {
            ...
            if (vm.src) {
              if (vm.src.endsWith(".svg")) {
                ...
                var type = vm.src.substring(
                  vm.src.indexOf("/") + 1,
                  vm.src.indexOf(";base64")
                );
      ...
      */
      ...
      function calculateGravity(offsetX, offsetY) {
        vm.onValueChanged({
          left:
            Math.min(Math.max(offsetX, 0), vm.dimensions.width) /
            vm.dimensions.width,
          top:
            Math.min(Math.max(offsetY, 0), vm.dimensions.height) /
    ...
    var umbImageGravityComponent = {
      template:
        '<div class="umb-cropper-gravity"> <div class="gravity-container" ng-show="vm.loaded"> <div class="viewport"> <img ng-show="vm.isCroppable" ng-src="{{vm.src}}" draggable="false"> <img ng-show="!vm.isCroppable && !vm.hasDimensions" ng-src="{{vm.src}}" width="200" height="200" draggable="false" style="cursor: default;"> </div> <div class="overlayViewport"> <div ng-show="vm.isCroppable && vm.disableFocalPoint !== true" class="overlay umb-outline" ng-style="vm.overlayStyle" ng-click="vm.setFocalPoint($event)"> <div class="focalPoint" ng-style="vm.style"> </div> </div> </div> </div> </div> ',
      bindings: {
        src: "<",
        center: "<",
        onImageLoaded: "&?",
    ...
    .directive(
      ...
      function ($timeout, localizationService, cropperHelper, $log) {
        return {
          ...
          replace: true,
          template:
            '<div class="umb-crop-thumbnail-container" ng-style="{height: height, width: width, overflow: \'hidden\', position: \'relative\'}" ng-show="loaded"> <img ng-src="{{src}}" ng-style="preview" class="noScale"> </div> ',
          scope: {
            src: "=",
            width: "@",
            height: "@",
    ...
    .directive("localize", function ($log, localizationService) {
      return {
        ...
        link: function link(scope, element, attrs) {
          ...
          function render() {
            element.html(
              localizationService.tokenReplace(scope.text, scope.tokens || null)
            );
          }
  ...
  (function () {
    "use strict";
    function MediaNodeInfoDirective(
      $timeout,
      $location,
      $q,
      eventsService,
      ...
      function link(scope, element, attrs, ctrl) {
        ...
        function formatDatesToLocal() {
          // get current backoffice user and format dates
          userService.getCurrentUser().then(function (currentUser) {
            scope.node.createDateFormatted = dateHelper.getLocalDate(
              scope.node.createDate,
              currentUser.locale,
              "LLL"
            );
            scope.node.updateDateFormatted = dateHelper.getLocalDate(
              scope.node.updateDate,
              currentUser.locale,
              "LLL"
            );
          });
        ...
        function loadContentRelations() {
          return mediaResource
            .getPagedReferences(scope.node.id, scope.contentOptions)
            .then(function (data) {
        ...
        function loadMediaRelations() {
          return mediaResource
            .getPagedReferences(scope.node.id, scope.mediaOptions)
            .then(function (data) {
        ...
        function loadMemberRelations() {
          return mediaResource
            .getPagedReferences(scope.node.id, scope.memberOptions)
            .then(function (data) {
    ...
    angular
      .module("umbraco.directives")
      .directive("umbMediaNodeInfo", MediaNodeInfoDirective);
  })();
  ("use strict");
  (function () {
    "use strict";
    function MemberGroupNodeInfoDirective(
      eventsService,
      userService,
      dateHelper
    ) {
    ...
    angular
      .module("umbraco.directives")
      .directive("umbMembergroupNodeInfo", MemberGroupNodeInfoDirective);
  })();
  ("use strict");
  (function () {
    "use strict";
    function MemberNodeInfoDirective(
      $timeout,
      $location,
      eventsService,
      userService,
    ...
    angular
      .module("umbraco.directives")
      .directive("umbMemberNodeInfo", MemberNodeInfoDirective);
  })();
  ("use strict");
  /**
   * @ngdoc directive
  ...
  (function () {
    ...
    angular
      .module("umbraco.directives")
      .directive("umbNotifications", NotificationDirective);
  })();
  ("use strict");
  /**
...
**/
  (function () {
    ...
    function OverlayDirective(
      ...
      function link(scope, el, attr, ctrl) {
        ...
        function setView() {
          if (scope.view) {
            ...
            if (scope.parentScope) {
              var element = el.find(".scoped-view");
              $http
                .get(scope.view, { cache: $templateCache })
                .then(function (response) {
        ...
        function setButtonText() {
          var labelKeys = ["general_close", "general_submit"];
          localizationService.localizeMany(labelKeys).then(function (values) {
            if (
              !scope.model.closeButtonLabelKey &&
              !scope.model.closeButtonLabel
            ) {
              scope.model.closeButtonLabel = values[0];
            }
            if (
              !scope.model.submitButtonLabelKey &&
              !scope.model.submitButtonLabel
            ) {
        ...
        function registerOverlay() {
          ...
          $(document).on("keydown.overlay-" + overlayNumber, function (event) {
            if (event.which === 27) {
              ...
              if (
                numberOfOverlays === overlayNumber &&
                !scope.model.disableEscKey
              ) {
                scope.$apply(function () {
                  scope.closeOverLay();
                });
            ...
            if (event.which === 13) {
              ...
              if (numberOfOverlays === overlayNumber) {
                var activeElementType = document.activeElement.tagName;
                var clickableElements = ["A", "BUTTON"];
                var submitOnEnter = document.activeElement.hasAttribute(
                  "overlay-submit-on-enter"
                );
                var submitOnEnterValue = submitOnEnter
        ...
        function setOverlayIndent() {
          ...
          if (
            (scope.position === "center" && overlayIndex > 0) ||
            (scope.position === "target" && overlayIndex > 0)
          ) {
        ...
        function setTargetPosition() {
          ...
          position.left = mousePositionClickX
            ? mousePositionClickX - elementWidth / 2
            : (containerLeft + containerRight) / 2 - elementWidth / 2;
          position.top = mousePositionClickY
            ? mousePositionClickY - elementHeight / 2
            : (containerTop + containerBottom) / 2 - elementHeight / 2;
          ...
          if (scope.model.submit) {
            if (
              ...
              if (
                ...
                scope.model.confirmSubmit.enable &&
    ...
    angular
      .module("umbraco.directives")
      .directive("umbOverlay", OverlayDirective);
  })();
  ("use strict");
  (function () {
    "use strict";
    ...
    angular
      .module("umbraco.directives")
      .directive("umbOverlayBackdrop", OverlayBackdropDirective);
  })();
  ("use strict");
  /**
   * @ngdoc directive
  ...
  (function () {
    ...
    function UmbPropertyController(
      $scope,
      userService,
      serverValidationManager,
      udiService,
      ...
      vm.getValidationPath = function () {
        var parentValidationPath = vm.parentUmbProperty
          ? vm.parentUmbProperty.getValidationPath()
          : null;
        ...
        var valPath = vm.elementKey
          ? vm.elementKey + "/" + propAlias
          : propAlias;
        return serverValidationManager.createPropertyValidationKey(
          valPath,
          parentValidationPath
        );
      };
      function onInit() {
        ...
        if (!vm.parentUmbProperty) {
          ...
          var found = angularHelper.traverseScopeChain($scope, function (s) {
            return (
              s && s.vm && s.vm.constructor.name === "UmbPropertyController"
            );
          });
  ...
  (function () {
     ...
     */
    function umbPropertyActionsController(
      keyboardService,
      localizationService
    ) {
      var vm = this;
    ...
    angular
      .module("umbraco.directives")
      .component("umbPropertyActions", umbPropertyActionsComponent);
  })();
  ("use strict");
  /**
   * @ngdoc directive
  ...
  function umbPropEditor(umbPropEditorHelper) {
    return {
      ...
      replace: true,
      template:
        '<div class="umb-property-editor db" ng-class="{\'umb-property-editor--preview\': preview}"> <div disable-tabindex="preview"> <div ng-include="propertyEditorView"></div> </div> </div> ',
      link: function link(scope, element, attrs, ctrl) {
  ...
  angular
    .module("umbraco.directives")
    .directive("umbPropertyEditor", umbPropEditor);
  ("use strict");
  angular
    .module("umbraco.directives.html")
...
**/
  (function () {
    ...
    angular.module("umbraco.directives").component("umbTabContent", {
      transclude: true,
      template:
        '<div data-element="tab-content-{{vm.tab.alias}}"> <ng-transclude></ng-transclude> </div> ',
      controllerAs: "vm",
      bindings: { tab: "<" },
    });
  })();
...
**/
  (function () {
    ...
    angular
      .module("umbraco.directives")
      .directive("umbTabsNav", TabsNavDirective);
  })();
  ("use strict");
  /**
@ngdoc directive
...
**/
  (function () {
    ...
    function umbTagsEditorController(
      $rootScope,
      assetsService,
      umbRequestHelper,
      angularHelper,
      ...
      function onInit() {
        ...
        assetsService
          .loadJs("lib/typeahead.js/typeahead.bundle.min.js")
          .then(function () {
            vm.isLoading = false;
                ...
                source: function source(query, syncCallback, asyncCallback) {
                  tagsHound.search(
                    ...
                    function (suggestions) {
                      syncCallback(
                        removeCurrentTagsFromSuggestions(suggestions)
                      );
                    },
                    function (suggestions) {
                      asyncCallback(
      ...
      function validateMandatory() {
        return {
          isValid:
            !vm.validation.mandatory ||
            (vm.viewModel != null && vm.viewModel.length > 0) ||
            (vm.value != null && vm.value.length > 0),
        ...
        if (code == 13) {
          ...
          if (
            $element
              .find(".tags-" + vm.inputId)
              .parent()
              .find(".tt-menu .tt-cursor").length === 0
          ) {
  ...
  (function () {
    ...
    function UmbContextDialog(
      ...
      var directive = {
        ...
        transclude: true,
        template:
          '<div id="dialog" class="umb-modalcolumn fill shadow" on-outside-click="outSideClick()" role="dialog" aria-labelledby="contextdialog-title" aria-describedby="contextdialog-description"> <div class="umb-modalcolumn-header"> <h1 id="contextdialog-title">{{dialogTitle}}</h1> <p id="contextdialog-description" class="sr-only"> <localize key="visuallyHiddenTexts_contextDialogDescription" tokens="[dialogTitle,currentNode.name]">Perform action {{dialogTitle}} on the {{currentNode.name}} node</localize> </p> </div> <div class="umb-modalcolumn-body" ng-include="view"></div> </div> ',
        scope: {
          dialogTitle: "<",
          currentNode: "<",
          view: "<",
    ...
    angular
      .module("umbraco.directives")
      .directive("umbContextDialog", UmbContextDialog);
  })();
  ("use strict");
  /**
   * @ngdoc directive
 ...
 */
  angular
    ...
    .directive(
        ...
        return {
          ...
          link: function link(scope, element, attrs, umbTreeCtrl) {
            ...
            function setupNodeDom(node, tree) {
              ...
              element
                .children(":first") //set the padding
            ...
            scope.getNodeCssClass = function (node) {
              ...
              if (actionNode && actionNode.nodeType === node.nodeType) {
                ...
                if (
                  String(node.id) === "-1" &&
                  actionNode.metaData.treeAlias === node.metaData.treeAlias
                ) {
                  css.push("active");
                }
              }
      ...
      */
            ...
            evts.push(
              eventsService.on("editors.tree.icon.changed", function (e, args) {
                if (
                  args.icon !== scope.node.icon &&
                  args.id === scope.node.id
                ) {
            ...
            function toggleDeleteAnimations() {
              ...
              var hide =
                !appState.getMenuState("showMenuDialog") &&
                !appState.getMenuState("showMenu");
              if (hide) {
                scope.node.deleteAnimations = false;
              } else {
            ...
            evts.push(
              eventsService.on(
                "appState.menuState.changed",
                function (e, args) {
                  if (
                    args.key === "showMenuDialog" ||
                    args.key == "showMenu" ||
                    args.key == "currentNode"
                  ) {
  ...
  angular
    .module("umbraco.directives")
    .directive("umbTreeSearchBox", treeSearchBox);
  ("use strict");
  /**
   * @ngdoc directive
  ...
  (function () {
    ...
    function AvatarDirective(localizationService) {
      ...
      var directive = {
        ...
        replace: true,
        template:
          '<div> <img class="umb-avatar umb-avatar--{{size}}" ng-if="imgSrc" ng-src="{{imgSrc}}" ng-srcset="{{imgSrcset}}" alt="{{avatarAlt}}"> <div class="umb-avatar umb-avatar--{{size}} umb-avatar--{{color}}" ng-if="!imgSrc"> <span ng-if="name">{{ initials }}</span> <span ng-if="!name">{{unknownChar}}</span> </div> </div> ',
        scope: {
          size: "@",
          name: "@",
          color: "@",
    ...
    angular
      .module("umbraco.directives")
      .directive("umbAvatar", AvatarDirective);
  })();
  ("use strict");
  /**
@ngdoc directive
...
**/
  ...
  (function () {
    ...
    angular
      .module("umbraco.directives")
      .directive("umbCheckmark", CheckmarkDirective);
  })();
  ("use strict");
  /**
@ngdoc directive
...
**/
  (function () {
    ...
    angular
      .module("umbraco.directives")
      .directive("umbChildSelector", ChildSelectorDirective);
  })();
  ("use strict");
  /**
@ngdoc directive
  ...
  (function () {
    ...
    function umbClipboardDirective($timeout, assetsService, $parse) {
      function link(scope, element, attrs, ctrl) {
        ...
        var target = element[0];
        assetsService
          .loadJs("lib/clipboard/clipboard.min.js", scope)
          .then(function () {
            if (attrs.umbClipboardTarget) {
              target.setAttribute(
                "data-clipboard-target",
                attrs.umbClipboardTarget
              );
            }
            if (attrs.umbClipboardAction) {
              target.setAttribute(
                "data-clipboard-action",
                attrs.umbClipboardAction
              );
            }
            if (attrs.umbClipboardText) {
              target.setAttribute(
                "data-clipboard-text",
                attrs.umbClipboardText
              );
            }
    ...
    angular
      .module("umbraco.directives")
      .directive("umbClipboard", umbClipboardDirective);
  })();
  ("use strict");
  /**
@ngdoc directive
...
**/
  (function () {
    ...
    angular
      .module("umbraco.directives")
      .component("umbCodeSnippet", umbCodeSnippet);
  })();
  ("use strict");
  /**
@ngdoc directive
  ...
  (function () {
    ...
    function ColorPickerController(
      ...
      function grabElementAndRun() {
        var labelKeys = ["general_cancel", "general_choose", "general_clear"];
        localizationService.localizeMany(labelKeys).then(function (values) {
...
**/
  (function () {
    ...
    function ColorSwatchesDirective() {
      function link(scope, el, attr, ctrl) {
        ...
        scope.setColor = function (color, $index, $event) {
          if (scope.onSelect) {
            ...
            if (
              ...
              scope.selectedColor.value === color.value
            ) {
        ...
        scope.isSelectedColor = function (color) {
          return (
            scope.selectedColor && color.value === scope.selectedColor.value
          );
        };
      }
      var directive = {
    ...
    angular
      .module("umbraco.directives")
      .directive("umbColorSwatches", ColorSwatchesDirective);
  })();
  ("use strict");
  /**
@ngdoc directive
...
**/
  function confirmDirective() {
    return {
      ...
      // replace the html element with the template
      template:
        '<div> <p ng-hide="!caption" class="umb-abstract">{{caption}}</p> <div class="btn-toolbar umb-btn-toolbar"> <umb-button ng-if="showCancel" type="button" action="onCancel()" button-style="link" disabled="confirmButtonState === \'busy\'" label-key="general_cancel"> </umb-button> <umb-button ng-if="showConfirm" type="button" action="confirm()" button-style="{{confirmButtonStyle || \'primary\'}}" state="confirmButtonState" disabled="confirmDisabled === true" label-key="{{confirmLabelKey || \'general_ok\'}}"> </umb-button> </div> </div>',
      scope: {
        onConfirm: "=",
        onCancel: "=",
        caption: "@",
  ...
  angular
    .module("umbraco.directives")
    .directive("umbConfirm", confirmDirective);
  ("use strict");
  /**
@ngdoc directive
...
**/
  (function () {
    ...
    angular
      .module("umbraco.directives")
      .directive("umbConfirmAction", ConfirmAction);
  })();
  ("use strict");
  /**
@ngdoc directive
  ...
  (function () {
    ...
    function ContentGridDirective() {
      ...
      var directive = {
        ...
        replace: true,
        template:
          '<div class="umb-content-grid"> <div class="umb-content-grid__item umb-outline umb-outline--surrounding" ng-repeat="item in content" ng-class="{\'-selected\': item.selected}" ng-click="clickItem(item, $event, $index)"> <div class="umb-content-grid__content"> <a class="umb-content-grid__item-name umb-outline" ng-href="{{\'#\' + item.editPath}}" ng-click="clickItemName(item, $event, $index)" ng-class="{\'-light\': !item.published && item.updater != null}"> <i class="umb-content-grid__icon {{ item.icon }}" aria-hidden="true"></i> <span>{{ item.name }}</span> </a> <ul class="umb-content-grid__details-list" ng-class="{\'-light\': !item.published && item.updater != null}"> <li class="umb-content-grid__details-item" ng-if="item.state"> <div class="umb-content-grid__details-label"><localize key="general_status"></localize>:</div> <div class="umb-content-grid__details-value"><umb-variant-state variant="item"></umb-variant-state></div> </li> <li class="umb-content-grid__details-item" ng-repeat="property in contentProperties"> <div class="umb-content-grid__details-label">{{ property.header }}:</div> <div class="umb-content-grid__details-value">{{ item[property.alias] }}</div> </li> </ul> </div> </div> <umb-empty-state ng-if="!content" position="center"> <localize key="content_noItemsToShow">There are no items to show</localize> </umb-empty-state> </div> ',
        scope: {
          content: "=",
          contentProperties: "=",
          onClick: "=",
    ...
    angular
      .module("umbraco.directives")
      .directive("umbContentGrid", ContentGridDirective);
  })();
  ("use strict");
  /**
@ngdoc directive
...
**/
  (function () {
    ...
    function umbDateTimePickerCtrl(
      $element,
      $timeout,
      $scope,
      assetsService,
      ...
      ctrl.$onInit = function () {
        ...
        assetsService
          .loadCss("lib/flatpickr/flatpickr.css", $scope)
          .then(function () {
            userService.getCurrentUser().then(function (user) {
              // init date picker
      ...
      function setDatepicker(element) {
        ...
        ctrl.options.onKeyDown = function (
          selectedDates,
          dateStr,
          instance,
          event
      ...
      function setUpCallbacks() {
        ...
        if (ctrl.options && ctrl.onMonthChange) {
          ctrl.options.onMonthChange = function (
            selectedDates,
            dateStr,
            instance
          ) {
        ...
        if (ctrl.options && ctrl.onYearChange) {
          ctrl.options.onYearChange = function (
            selectedDates,
            dateStr,
            instance
          ) {
        ...
        if (ctrl.onValueUpdate) {
          ctrl.options.onValueUpdate = function (
            selectedDates,
            dateStr,
            instance
          ) {
        ...
        if (ctrl.onDayCreate) {
          ctrl.options.onDayCreate = function (
            selectedDates,
            dateStr,
            instance
          ) {
    ...
    angular
      .module("umbraco.directives")
      .component("umbFlatpickr", umbDateTimePicker);
    angular
      .module("umbraco.directives")
      .component("umbDateTimePicker", umbDateTimePicker);
  })();
  ("use strict");
  (function () {
    "use strict";
    ...
    angular
      .module("umbraco.directives")
      .directive("umbDisableFormValidation", UmbDisableFormValidation);
  })();
  ("use strict");
  /**
@ngdoc directive
...
**/
  (function () {
    ...
    angular
      .module("umbraco.directives")
      .directive("umbDropdownItem", umbDropdownItem);
  })();
  ("use strict");
  /**
@ngdoc directive
  ...
  (function () {
    ...
    function EmptyStateDirective() {
      var directive = {
        ...
        transclude: true,
        template:
          "<div class=\"umb-empty-state\" ng-class=\"{ '-small': size === 'small', '-large': size === 'large', '-center': position === 'center' }\" ng-transclude> </div> ",
        scope: {
          size: "@",
          position: "@",
        },
    ...
    angular
      .module("umbraco.directives")
      .directive("umbEmptyState", EmptyStateDirective);
  })();
  ("use strict");
  /**
@ngdoc directive
...
**/
  (function () {
    ...
    var component = {
      template:
        '<span class="umb-file-icon umb-file-icon--{{vm.size}}"> <span class="file-icon"> <i class="icon {{vm.icon}}" aria-hidden="true"></i> <span ng-if="vm.extension">.{{vm.extension}}</span> </span> <small ng-if="vm.text">{{vm.text}}</small> </span> ',
      bindings: {
        extension: "@?",
        icon: "@?",
        size: "@?",
  ...
  (function () {
    ...
    function FolderGridDirective() {
      ...
      var directive = {
        ...
        replace: true,
        template:
          '<div class="umb-folder-grid"> <div class="umb-folder-grid__folder" ng-repeat="folder in folders" ng-class="{\'-selected\': folder.selected}" ng-click="clickFolder(folder, $event, $index)"> <div class="umb-folder-grid__folder-description"> <i class="umb-folder-grid__folder-icon {{ folder.icon }}"></i> <div ng-click="clickFolderName(folder, $event, $index)" class="umb-folder-grid__folder-name">{{ folder.name }}</div> </div>  </div> </div> ',
        scope: {
          folders: "=",
          onClick: "=",
          onClickName: "=",
    ...
    angular
      .module("umbraco.directives")
      .directive("umbFolderGrid", FolderGridDirective);
  })();
  ("use strict");
  /**
@ngdoc directive
...
**/
  angular
    ...
    .directive(
      "umbGenerateAlias",
      function ($timeout, entityResource, localizationService) {
        return {
          restrict: "E",
          template:
            '<div> <span class="umb-locked-field__text cursor-not-allowed" ng-show="!enableLock">{{ alias }}</span> <div ng-show="enableLock"> <umb-locked-field locked="locked" ng-model="alias" placeholder-text="placeholderText" validation-position="validationPosition" server-validation-field="{{serverValidationField}}"> </umb-locked-field> </div> </div> ',
          replace: true,
          scope: {
            alias: "=",
            aliasFrom: "=",
          ...
          link: function link(scope, element, attrs, ctrl) {
            ...
            localizationService
              .localize("placeholders_generatingAlias")
              .then(function (value) {
  ...
  (function () {
    ...
    angular
      .module("umbraco.directives")
      .directive("umbGridSelector", GridSelector);
  })();
  ("use strict");
  (function () {
    "use strict";
    function GroupsBuilderDirective(
      contentTypeHelper,
      contentTypeResource,
      mediaTypeResource,
      dataTypeHelper,
      ...
      function link(scope, el, attr, ctrl) {
        ...
        function activate() {
          ...
          // localize texts
          localizationService
            .localize("validation_validation")
            .then(function (value) {
              validationTranslated = value;
            });
          localizationService
            .localize("contentTypeEditor_tabHasNoSortOrder")
            .then(function (value) {
        ...
        function filterAvailableCompositions(selectedContentType, selecting) {
          ...
          var selectedContentTypeAliases = selecting //the user has selected the item so add to the current list
            ? _.union(scope.compositionsDialogModel.compositeContentTypes, [
                selectedContentType.alias,
              ]) //the user has unselected the item so remove from the current list
            : _.reject(
                scope.compositionsDialogModel.compositeContentTypes,
                function (i) {
          ...
          var propAliasesExisting = _.filter(
            _.flatten(
              _.map(scope.model.groups, function (g) {
          ...
          var resourceLookup =
            scope.contentType === "documentType"
              ...
              : mediaTypeResource.getAvailableCompositeContentTypes;
          return resourceLookup(
            scope.model.id,
            selectedContentTypeAliases,
            propAliasesExisting
          ).then(function (filteredAvailableCompositeTypes) {
            scope.compositionsDialogModel.availableCompositeContentTypes.forEach(
              function (current) {
                //reset first
                ...
                current.allowed =
                  (scope.model.lockedCompositeContentTypes.includes(
                    current.contentType.alias
                  ) &&
                    selectedContentTypeAliases.includes(
                      current.contentType.alias
                    )) ||
                  (found ? found.allowed : false);
              }
            );
          });
        }
        function updatePropertiesSortOrder() {
          angular.forEach(scope.model.groups, function (group) {
            if (group.tabState !== "init") {
              group.properties = contentTypeHelper.updatePropertiesSortOrder(
                group.properties
              );
            }
          });
        ...
        function setupAvailableContentTypesModel(result) {
          ...
          scope.compositionsDialogModel.availableCompositeContentTypes.forEach(
            function (c) {
              ...
              if (
                scope.compositionsDialogModel.compositeContentTypes.includes(
                  c.contentType.alias
                )
              ) {
                c.allowed = true;
            ...
            for (var i = 0; i < scope.model.groups.length; i++) {
              ...
              if (group.tabState !== "init" && group.sortOrder === undefined) {
                ...
                notificationsService.error(
                  validationTranslated +
                    ": " +
                    group.name +
                    " " +
                    tabNoSortOrderTranslated
                );
              }
            }
            if (!sortOrderMissing) {
        ...
        scope.openCompositionsDialog = function () {
          scope.compositionsDialogModel = {
            ...
            close: function close(oldModel) {
              ...
              scope.model.compositeContentTypes =
                oldModel.contentType.compositeContentTypes;
              // remove overlay
              editorService.close();
            },
            selectCompositeContentType: function selectCompositeContentType(
              selectedContentType
            ) {
              var deferred = $q.defer();
              ...
              var newSelection =
                scope.model.compositeContentTypes.indexOf(
                  selectedContentType.alias
                ) === -1;
              if (newSelection) {
                ...
                var resourceLookup =
                  scope.contentType === "documentType"
                    ? contentTypeResource.getById
                    : mediaTypeResource.getById;
                resourceLookup(selectedContentType.id).then(function (
                  composition
                ) {
                  //based on the above filtering we shouldn't be able to select an invalid one, but let's be safe and
                  // double check here.
                  var overlappingAliases =
                    contentTypeHelper.validateAddingComposition(
                      scope.model,
                      composition
                    );
                  if (overlappingAliases.length > 0) {
                    ...
                    scope.compositionsDialogModel.compositeContentTypes.splice(
                      scope.compositionsDialogModel.compositeContentTypes.indexOf(
                        composition.alias
                      ),
                      1
                    );
                ...
                contentTypeHelper.splitCompositeContentType(
                  scope.model,
                  selectedContentType
                );
                //based on the selection, we need to filter the available composite types list
          ...
          $q.all([
            ...
            availableContentTypeResource(
              scope.model.id,
              [],
              propAliasesExisting,
              scope.model.isElement
            ).then(function (result) {
              setupAvailableContentTypesModel(result);
            }),
            //get where used document types
            whereUsedContentTypeResource(scope.model.id).then(function (
              whereUsed
            ) {
            ...
            countContentTypeResource().then(function (result) {
              scope.compositionsDialogModel.totalContentTypes = parseInt(
                result,
                10
              );
            }),
        ...
        scope.canRemoveGroup = function (group) {
          return (
            ...
            _.find(group.properties, function (property) {
        ...
        scope.changeSortOrderValue = function (group) {
          ...
          scope.model.groups = $filter("orderBy")(
            scope.model.groups,
            "sortOrder"
          );
        };
        ...
        scope.editPropertyTypeSettings = function (property, group) {
          if (!property.inherited) {
            ...
            if (oldPropertyModel.allowCultureVariant === undefined) {
              ...
              oldPropertyModel.allowCultureVariant =
                scope.model.allowCultureVariant;
            ...
            var propertySettings = {
              ...
              submit: function submit(model) {
                ...
                property.validation.mandatory =
                  propertyModel.validation.mandatory;
                property.validation.mandatoryMessage =
                  propertyModel.validation.mandatoryMessage;
                property.validation.pattern = propertyModel.validation.pattern;
                property.validation.patternMessage =
                  propertyModel.validation.patternMessage;
                property.showOnMemberProfile =
                  propertyModel.showOnMemberProfile;
                ...
                property.allowCultureVariant =
                  propertyModel.allowCultureVariant;
                property.allowSegmentVariant =
                  propertyModel.allowSegmentVariant;
        ...
        eventBindings.push(
          eventsService.on(
            "editors.dataTypeSettings.saved",
            function (name, args) {
    ...
    angular
      .module("umbraco.directives")
      .directive("umbGroupsBuilder", GroupsBuilderDirective);
  })();
  ("use strict");
  /**
@ngdoc directive
  ...
  (function () {
    ...
    function UmbIconDirective(iconHelper) {
      var directive = {
        ...
        transclude: true,
        template:
          '<span aria-hidden="true" class="umb-icon"> <span ng-if="svgString" ng-bind-html="svgString"></span> <i ng-if="!svgString && icon" class="{{icon}}"></i> </span> ',
        scope: {
          icon: "@",
          svgString: "=?",
        },
        link: function link(scope, element) {
          if (
            scope.svgString === undefined &&
            scope.svgString !== null &&
            scope.icon !== undefined &&
            scope.icon !== null
          ) {
            var observer = new IntersectionObserver(_lazyRequestIcon, {
              rootMargin: "100px",
            });
...
**/
  (function () {
        ...
        function loadImg(changes) {
          changes.forEach(function (change) {
            if (
              ...
              change.target.src.indexOf(placeholder) > 0
            ) {
    ...
    angular
      .module("umbraco.directives")
      .directive("umbImageLazyLoad", ImageLazyLoadDirective);
  })();
  ("use strict");
  /**
@ngdoc directive
  ...
  (function () {
    ...
    angular
      ...
      .directive(
        ...
        KeyboardShortcutsOverviewDirective
      );
  })();
  ("use strict");
  (function () {
...
**/
  (function () {
    ...
    angular
      .module("umbraco.directives")
      .directive("umbLightbox", LightboxDirective);
  })();
  ("use strict");
  (function () {
    "use strict";
    function ListViewLayoutDirective() {
      ...
      var directive = {
        ...
        replace: true,
        template:
          '<div> <div ng-include="options.layout.activeLayout.path"></div> </div> ',
        scope: {
          contentId: "<",
          folders: "<",
          items: "<",
    ...
    angular
      .module("umbraco.directives")
      .directive("umbListViewLayout", ListViewLayoutDirective);
  })();
  ("use strict");
  (function () {
    "use strict";
    function ListViewSettingsDirective(
      dataTypeResource,
      dataTypeHelper,
      editorService,
      listViewPrevalueHelper
    ) {
      function link(scope) {
        scope.dataType = {};
        ...
        var showSettingsOverlay = function showSettingsOverlay() {
          var overlay = {
            ...
            submit: function submit(model) {
              var preValues = dataTypeHelper.createPreValueProps(
                model.dataType.preValues
              );
              // store data type
              dataTypeResource
                .save(model.dataType, preValues, false)
                .then(function (dataType) {
        ...
        scope.createCustomListViewDataType = function () {
          scope.loading = true;
          dataTypeResource
            .createCustomListView(scope.modelAlias)
            .then(function (dataType) {
              // store data type
              setDataType(dataType);
        ...
        scope.removeCustomListDataType = function () {
          ...
          dataTypeResource
            .deleteById(scope.dataType.id)
            .then(function (dataType) {
              // set list view name on scope
              scope.listViewName = "List View - ".concat(
                scope.contentType === "documentType" ? "Content" : "Media"
              );
              // get default data type
              dataTypeResource
                .getByName(scope.listViewName)
                .then(function (defaultDataType) {
                  // store data type
        ...
        /* ----------- SCOPE WATCHERS ----------- */
        var unbindEnableListViewWatcher = scope.$watch(
          "enableListView",
          function (newValue) {
    ...
    angular
      .module("umbraco.directives")
      .directive("umbListViewSettings", ListViewSettingsDirective);
  })();
  ("use strict");
  /**
@ngdoc directive
  ...
  (function () {
    ...
    function UmbLoaderDirective() {
      ...
      var directive = {
        ...
        replace: true,
        template:
          "<div class=\"umb-loader-wrapper\" ng-class=\"{ '-top': position === 'top', '-bottom': position === 'bottom' }\"> <div class=\"umb-loader\"></div> </div> ",
        scope: { position: "@?" },
        link: link,
      };
      return directive;
    ...
    angular
      .module("umbraco.directives")
      .directive("umbLoader", UmbLoaderDirective);
  })();
  ("use strict");
  /**
@ngdoc directive
  ...
  (function () {
    ...
    function UmbLoadIndicatorDirective() {
      var directive = {
        ...
        replace: true,
        template:
          '<ul class="umb-load-indicator animated -half-second"> <li class="umb-load-indicator__bubble"></li> <li class="umb-load-indicator__bubble"></li> <li class="umb-load-indicator__bubble"></li> </ul> ',
      };
      return directive;
    }
    angular
      .module("umbraco.directives")
      .directive("umbLoadIndicator", UmbLoadIndicatorDirective);
  })();
  ("use strict");
  /**
@ngdoc directive
...
**/
  (function () {
    ...
    function LockedFieldDirective($timeout, localizationService) {
      function link(scope, el, attr, ngModelCtrl) {
        function activate() {
          ...
          if (
            scope.regexValidation === undefined ||
            scope.regexValidation === null
          ) {
            scope.regexValidation = "^[a-zA-Z]\\w.*$";
          }
          if (
            scope.serverValidationField === undefined ||
            scope.serverValidationField === null
          ) {
            scope.serverValidationField = "";
          }
          // if locked state is not defined as an attr set default state
          if (
            scope.placeholderText === undefined ||
            scope.placeholderText === null
          ) {
            scope.placeholderText = "Enter value...";
          }
          if (
            scope.validationPosition === undefined ||
            scope.validationPosition === null
          ) {
    ...
    angular
      .module("umbraco.directives")
      .directive("umbLockedField", LockedFieldDirective);
  })();
  ("use strict");
  /**
@ngdoc directive
  ...
  (function () {
    ...
    function MediaGridDirective($filter, mediaHelper) {
      function link(scope, el, attr, ctrl) {
        ...
        var unbindItemsWatcher = scope.$watch(
          "items",
          function (newValue, oldValue) {
    ...
    angular
      .module("umbraco.directives")
      .directive("umbMediaGrid", MediaGridDirective);
  })();
  ("use strict");
  (function () {
    "use strict";
    function MiniListViewDirective(entityResource, iconHelper) {
      function link(scope, el, attr, ctrl) {
        ...
        function getChildrenForMiniListView(miniListView) {
          ...
          entityResource
            .getPagedChildren(
              miniListView.node.id,
              scope.entityType,
              miniListView.pagination
            )
            .then(function (data) {
              if (!data.items) {
                data.items = [];
              ...
              miniListView.children.forEach(function (c) {
                ...
                if (
                  scope.entityTypeFilter &&
                  scope.entityTypeFilter.filter &&
                  !scope.entityTypeFilter.filterAdvanced
                ) {
                  var a = scope.entityTypeFilter.filter
                    .toLowerCase()
                    .replace(/\s/g, "")
                    .split(",");
                  var found =
                    a.indexOf(c.metaData.ContentTypeAlias.toLowerCase()) >= 0;
                  if (
                    (!scope.entityTypeFilter.filterExclude && !found) ||
                    (scope.entityTypeFilter.filterExclude && found)
                  ) {
                    c.allowed = false;
                  }
              ...
              if (
                ...
                var filtered = Utilities.isFunction(
                  scope.entityTypeFilter.filter
                )
                  ? _.filter(
                      miniListView.children,
                      scope.entityTypeFilter.filter
                    )
                  : _.where(
                      miniListView.children,
        ...
        scope.clickBreadcrumb = function (ancestor) {
          ...
          angular.forEach(miniListViewsHistory, function (historyItem, index) {
            ...
            if (historyItem.node.id.toString() === ancestor.id.toString()) {
              ...
              miniListViewsHistory.splice(
                index + 1,
                miniListViewsHistory.length
              );
              found = true;
            }
          });
        ...
        scope.showBackButton = function () {
          ...
          if (
            (scope.node.metaData && scope.node.metaData.IsContainer) ||
            scope.node.isContainer
          ) {
            return false;
          } else {
            return true;
    ...
    angular
      .module("umbraco.directives")
      .directive("umbMiniListView", MiniListViewDirective);
  })();
  ("use strict");
  (function () {
    "use strict";
  ...
  angular.module("umbraco.directives").directive("umbNestedContentEditor", [
    function () {
          ...
          if (args.key === $scope.model.key) {
            ...
            angular.forEach($scope.ngModel.variants[0].tabs, function (tab) {
              if (tab.alias.toLowerCase() === selectedTab.alias.toLowerCase()) {
                var localPropsMap = selectedTab.properties.reduce(function (
                  map,
                  obj
                ) {
                  map[obj.alias] = obj;
      ...
      return {
        ...
        templateUrl:
          Umbraco.Sys.ServerVariables.umbracoSettings.umbracoPath +
          "/views/propertyeditors/nestedcontent/nestedcontent.editor.html",
        scope: {
          ngModel: "=",
          tabAlias: "=",
        },
...
**/
  (function () {
    ...
    angular
      .module("umbraco.directives")
      .directive("umbNodePreview", NodePreviewDirective);
  })();
  ("use strict");
  /**
@ngdoc directive
  ...
  (function () {
    ...
    function PaginationDirective(localizationService) {
      function link(scope, el, attr, ctrl) {
        ...
        var unbindPageNumberWatcher = scope.$watchCollection(
      ...
      var directive = {
        ...
        replace: true,
        template:
          '<div class="umb-pagination pagination"> <div ng-show="pagination.length > 1"> <ul> <li ng-class="{disabled:pageNumber <= 1}"> <button type="button" class="btn-reset" ng-disabled="pageNumber <= 1" ng-click="prev()"> <localize key="general_previous">Previous</localize> </button> </li> <li ng-repeat="pgn in pagination track by $index" ng-class="{active:pgn.isActive}"> <button type="button" class="btn-reset" ng-click="goToPage(pgn.val - 1)" ng-bind="pgn.name ? pgn.name : pgn.val" ng-disabled="pgn.val === pageNumber" ng-if="pgn.val != \'...\'"> </button> <span ng-bind="pgn.val" ng-if="pgn.val == \'...\'"></span> </li> <li ng-class="{disabled:pageNumber >= totalPages}"> <button type="button" class="btn-reset" ng-disabled="pageNumber >= totalPages" ng-click="next()"> <localize key="general_next">Next</localize> </button> </li> </ul> </div> </div> ',
        scope: {
          pageNumber: "=",
          totalPages: "=",
          onNext: "=",
    ...
    angular
      .module("umbraco.directives")
      .directive("umbPagination", PaginationDirective);
  })();
  ("use strict");
  /**
@ngdoc directive
  ...
  (function () {
    ...
    function ProgressBarDirective() {
      var directive = {
        ...
        replace: true,
        template:
          '<span class="umb-progress-bar umb-progress-bar--{{size}}"> <span class="umb-progress-bar__progress" style="width: {{percentage}}%"></span> </span> ',
        scope: {
          percentage: "@",
          size: "@?",
        },
    ...
    angular
      .module("umbraco.directives")
      .directive("umbProgressBar", ProgressBarDirective);
  })();
  ("use strict");
  /**
@ngdoc directive
...
**/
  (function () {
    ...
    angular
      .module("umbraco.directives")
      .directive("umbProgressCircle", ProgressCircleDirective);
  })();
  ("use strict");
  /**
@ngdoc directive
...
**/
  (function () {
    ...
    function UmbRangeSliderController(
      $element,
      $timeout,
      $scope,
      assetsService
      ...
      ctrl.$onInit = function () {
        ...
        assetsService
          .loadJs("lib/nouislider/nouislider.min.js", $scope)
          .then(function () {
            // init date picker
            grabElementAndRun();
          });
            ...
            pools.forEach(function (pool, poolIndex) {
              ...
              for (var j = 0; j < handlesInPool; j++) {
                ...
                if (j === handlesInPool - 1) {
                  ...
                  var tooltipValues = poolValues[poolIndex].filter(function (
                    v,
                    i,
                    a
                  ) {
    ...
    angular
      .module("umbraco.directives")
      .component("umbRangeSlider", umbRangeSlider);
  })();
  ("use strict");
  /**
@ngdoc directive
...
**/
  (function () {
    ...
    **/
      var observeHeader = function observeHeader(current, container) {
        headerObserver = new IntersectionObserver(
          function (records, observer) {
            var _ref = [records[0].boundingClientRect, records[0].rootBounds],
              target = _ref[0],
              rootBounds = _ref[1];
            if (rootBounds && target) {
              ...
              if (
                target.bottom >= rootBounds.top &&
                target.bottom < rootBounds.bottom
              ) {
        ...
        headerObserver.observe(
          current.parentElement.querySelector(".umb-sticky-sentinel.-top")
        );
      };
      function link(scope, el, attr, ctrl) {
        var current = el[0];
        var container =
          current.closest(".umb-editor-container") ||
          current.closest(".umb-dashboard");
        if (container) {
          addSentinel(current);
    ...
    angular
      .module("umbraco.directives")
      .directive("umbStickyBar", StickyBarDirective);
  })();
  ("use strict");
  /**
@ngdoc directive
...
**/
  (function () {
    ...
    angular
      .module("umbraco.directives")
      .directive("umbTooltip", TooltipDirective);
  })();
  ("use strict");
  /**
   * @ngdoc directive
...
*/
        ...
        return {
          ...
          link: function link(scope, element, attrs) {
            ...
            function _filterFile(file) {
              ...
              if (
                ignoreFileNames.indexOf(file.name) === -1 &&
            ...
            function _filesQueued(files, event) {
              ...
              if (!scope.working) {
                ...
                if (
                  ...
                  !scope.acceptedMediatypes.length
                ) {
                ...
                if (
                  scope.acceptedMediatypes &&
                  _requestChooseMediaTypeDialog() === false
                ) {
            ...
            function _upload(file) {
              scope.propertyAlias = scope.propertyAlias
                ? scope.propertyAlias
                : "umbracoFile";
              scope.contentTypeAlias = scope.contentTypeAlias
            ...
            function _requestChooseMediaTypeDialog() {
              ...
              var uploadFileExtensions = scope.queue.map(function (file) {
                return mediaHelper.getFileExtension(file.name);
              });
              var filteredMediaTypes =
                mediaTypeHelper.getTypeAcceptingFileExtensions(
                  scope.acceptedMediatypes,
                  uploadFileExtensions
                );
              var mediaTypesNotFile = filteredMediaTypes.filter(function (
                mediaType
              ) {
                return mediaType.alias !== "File";
              });
                  ...
                  var dialog = {
                    ...
                    close: function close() {
                      scope.queue.map(function (file) {
                        file.uploadStatus = "error";
                        file.serverErrorMessage =
                          "No files uploaded, no mediatype selected";
                        scope.rejected.push(file);
                      });
                      scope.queue = [];
                      overlayService.close();
  ...
  angular
    .module("umbraco.directives")
    .directive("umbFileUpload", umbFileUpload);
  ("use strict");
  (function () {
    "use strict";
    /**
     ...
     */
    function umbPropertyFileUploadController(
      $scope,
      $q,
      fileManager,
      mediaHelper,
      ...
      function checkPendingClientFiles() {
        ...
        var existingClientFiles = _.map(
          _.filter(fileManager.getFiles(), function (f) {
            return (
              f.alias === vm.propertyAlias &&
              f.culture === vm.culture &&
              f.segment === vm.segment
            );
          }),
          function (f) {
            return f.file;
      ...
      function onChanges(changes) {
        if (
          ...
          if (!changes.value.currentValue && changes.value.previousValue) {
            ...
            //create the property to show the list of files currently saved
            if (existingClientFiles.length > 0) {
              updateModelFromSelectedFiles(existingClientFiles).then(
                function () {
  ...
  function umbSingleFileUpload($compile) {
    ...
    var innerTemplate =
      "<input type='file' umb-file-upload accept='{{acceptFileExt}}'/>";
    return {
      restrict: "E",
      scope: {
        rebuild: "=",
  ...
  angular
    .module("umbraco.directives")
    .directive("umbSingleFileUpload", umbSingleFileUpload);
  ("use strict");
  (function () {
    "use strict";
    function ChangePasswordController($scope) {
      ...
      */
        ...
        if (!isNew) {
          ...
          vm.passwordValues.newPassword &&
          vm.passwordValues.newPassword.length > 0
        ) {
      ...
      function onInit() {
        ...
        vm.changing =
          vm.config.disableToggle === true || !vm.config.hasPassword;
      ...
      function showOldPass() {
        return (
          vm.config.hasPassword &&
          !vm.config.allowManuallyChangingPassword &&
          !vm.config.enablePasswordRetrieval &&
          !vm.showReset
        );
      }
...
**/
  (function () {
    ...
    angular
      .module("umbraco.directives")
      .directive("umbUserGroupPreview", UserGroupPreviewDirective);
  })();
  ("use strict");
  (function () {
    "use strict";
    function UserPreviewDirective() {
      ...
      var directive = {
        ...
        replace: true,
        template:
          '<div class="umb-user-preview"> <div class="umb-user-preview__avatar"> <umb-avatar size="xxs" color="secondary" name="{{name}}" img-src="{{avatars[0]}}" img-srcset="{{avatars[1]}} 2x, {{avatars[2]}} 3x"> </umb-avatar> </div> <div class="umb-user-preview__content"> <div class="umb-user-preview__name">{{ name }}</div> </div> <div class="umb-user-preview__actions"> <button type="button" class="umb-user-preview__action umb-user-preview__action--red btn-link" title="Remove {{name}}" ng-if="allowRemove" ng-click="onRemove()"> <localize key="general_remove">Remove</localize> <span class="sr-only">{{name}}</span> </button> <div> </div> </div></div>',
        scope: {
          avatars: "=?",
          name: "=",
          allowRemove: "=?",
    ...
    angular
      .module("umbraco.directives")
      .directive("umbUserPreview", UserPreviewDirective);
  })();
  ("use strict");
  /**
* @ngdoc directive
...
**/
  ...
  angular
    .module("umbraco.directives")
    .directive("retriveDomElement", function () {
...
**/
  ...
  (function () {
    ...
    function showValidationOnSubmit(serverValidationManager) {
      return {
        ...
        link: function link(scope, element, attr, ctrl) {
          ...
          //reset the status.
          var submitted =
            element.closest(".show-validation").length > 0 ||
            (formMgr && formMgr.showValidation);
          if (!submitted) {
    ...
    angular
      .module("umbraco.directives.validation")
      .directive("showValidationOnSubmit", showValidationOnSubmit);
  })();
  ("use strict");
  (function () {
    "use strict";
    ...
    angular
      .module("umbraco.directives")
      .directive("umbSetDirtyOnChange", SetDirtyOnChange);
  })();
  ("use strict");
  angular
    .module("umbraco.directives.validation")
  ...
  function valFormManager(
    ...
    function ValFormManagerController($scope) {
      ...
      this.getValidationMessageType = function () {
        return $scope.valMsgType;
      };
      this.notify = notify;
    ...
    function getAncestorValFormManager(scope, ctrls, index) {
      ...
      var found = angularHelper.traverseScopeChain(scope, function (s) {
        return (
          s &&
          s.valFormManager &&
          s.valFormManager.constructor.name === "ValFormManagerController"
        );
      });
    ...
    return {
      ...
      link: function link(scope, element, attr, ctrls) {
        ...
        var parentFormMgr = (scope.parentFormMgr = getAncestorValFormManager(
          scope,
          ctrls,
          1
        ));
        ...
        if (
          serverValidationManager.items.length > 0 ||
          (parentFormMgr && parentFormMgr.isShowingValidation())
        ) {
          element.addClass(SHOW_VALIDATION_CLASS_NAME);
          scope.showValidation = true;
          var parentValMsgType = parentFormMgr
            ? parentFormMgr.getValidationMessageType()
            : 2;
        ...
        unsubscribe.push(
          scope.$on(SAVING_EVENT_NAME, function (ev, args) {
            var messageType = 2;
            //error
            switch (args.action) {
              case "save":
        ...
        unsubscribe.push(
          scope.$on(SAVED_EVENT_NAME, function (ev, args) {
        ...
        var locationEvent = $rootScope.$on(
          "$locationChangeStart",
          function (event, nextLocation, currentLocation) {
            var infiniteEditors = editorService.getEditors();
            if (
              (!formCtrl.$dirty && infiniteEditors.length === 0) ||
              (isSavingNewItem && infiniteEditors.length === 0)
            ) {
              return;
            }
            ...
            if (nextPath && !confirmed) {
              if (
                navigationService.isRouteChangingNavigation(
                  currentLocation,
                  nextLocation
                )
              ) {
  ...
  angular
    .module("umbraco.directives.validation")
    .directive("valHighlight", valHighlight);
  ("use strict");
  (function () {
    /**
     * @ngdoc directive
    ...
    function multi($parse, $rootScope) {
      return {
        ...
        link: function link(scope, elem, attrs, ngModelCtrl) {
          ...
          var deregisterListener = scope.$on(
            "multi:valueChanged",
            function (event) {
              ngModelCtrl.$setValidity("multi", validate());
            }
    ...
    angular
      .module("umbraco.directives.validation")
      .directive("multi", ["$parse", "$rootScope", multi]);
  })();
  ("use strict");
  /**
   * @ngdoc directive
  ...
  function valPropertyMsg(
    ...
    return {
      ...
      restrict: "E",
      template:
        "<div ng-show=\"errorMsg != ''\" class='alert alert-error property-error' >{{errorMsg}}</div>",
      scope: {},
      link: function link(scope, element, attrs, ctrl) {
        var unsubscribe = [];
        var watcher = null;
        ...
        var isMandatory = currentProperty.validation
          ? currentProperty.validation.mandatory
          : undefined;
        var labels = {};
        ...
        if (umbVariantCtrl) {
          ...
          if (
            umbVariantCtrl.content.variants.length > 1 &&
            (!currentVariant.language || !currentVariant.language.isDefault) &&
            !currentCulture &&
            !currentSegment &&
            !currentProperty.unlockInvariantValue
          ) {
        ...
        function getErrorMsg() {
          ...
          if (scope.currentProperty) {
            ...
            var err = serverValidationManager.getPropertyError(
            ...
            if (err && err.errorMsg) {
              ...
              return scope.currentProperty.propertyErrorMessage
                ? scope.currentProperty.propertyErrorMessage
                : labels.propertyHasErrors;
            }
          }
        ...
        function checkAndClearError() {
          ...
          if (
            (errCount === 1 && hasOwnErr) ||
            (errCount === 2 && hasOwnErr && hasValServer)
          ) {
        ...
        function isLastServerError(propertyValidationPath) {
          var nestedErrs =
            serverValidationManager.getPropertyErrorsByValidationPath(
              propertyValidationPath,
              currentCulture,
              currentSegment,
              { matchType: "prefix" }
          ...
          if (
            nestedErrs.length === 0 ||
            (nestedErrs.length === 1 &&
              nestedErrs[0].propertyAlias === propertyValidationPath)
          ) {
            return true;
          }
          return false;
          ...
          controls.forEach(function (ctrl) {
            if (angularHelper.isForm(ctrl)) {
              ...
              if (ctrl.$name !== formCtrl.$name) {
                collectAllNgModelControllersRecursively(
                  ctrl.$getControls(),
                  ngModels
                );
              }
            } else if (
              ctrl.hasOwnProperty("$modelValue") &&
              Utilities.isObject(ctrl.$validators)
            ) {
              ngModels.push(ctrl);
            }
          });
          ...
          if (!watcher) {
            watcher = scope.$watchCollection(
              ...
              function (updatedFormController) {
                var childControls = updatedFormController.$getControls();
                var ngModels = [];
                collectAllNgModelControllersRecursively(
                  childControls,
                  ngModels
                ...
                ngModels.forEach(function (x) {
                  if (!x.$validators.serverValidityResetter) {
                    x.$validators.serverValidityResetter =
                      resetServerValidityValidator(x);
                  }
                });
              }
            );
        ...
        function checkValidationStatus() {
          if (formCtrl.$invalid) {
            ...
            if (
              formCtrl.$error.valPropertyMsg &&
              formCtrl.$error.valPropertyMsg.length > 0
            ) {
              ...
              _.without(_.keys(formCtrl.$error), "valPropertyMsg").length > 0
            ) {
              ...
              if (
                ...
                try {
                  for (
                    var _iterator = formCtrl.$getControls()[Symbol.iterator](),
                      _step;
                    !(_iteratorNormalCompletion = (_step = _iterator.next())
                      .done);
                    _iteratorNormalCompletion = true
        ...
        function onInit() {
          localizationService
            .localize("errors_propertyHasErrors")
            .then(function (data) {
              ...
              if (scope.currentProperty) {
                ...
                var serverValidationManagerCallback =
                  function serverValidationManagerCallback(
                    isValid,
                    propertyErrors,
                    allErrors
                  ) {
                    ...
                    if (hasError) {
                      ...
                      scope.errorMsg =
                        propertyErrors.length > 1
                          ? labels.propertyHasErrors
                          : propertyErrors[0].errorMsg ||
                            labels.propertyHasErrors;
  ...
  angular
    .module("umbraco.directives.validation")
    .directive("valPropertyMsg", valPropertyMsg);
  ("use strict");
  /**
* @ngdoc directive
...
**/
    ...
    return {
      ...
      link: function link(scope, element, attrs, ctrls) {
        ...
        if (
          ...
          throw new Error(
            "val-property-validator directive must specify a function to call"
          );
        }
        // Validation method
  ...
  angular
    .module("umbraco.directives.validation")
    .directive("valPropertyValidator", valPropertyValidator);
  ("use strict");
  /**
   * @ngdoc directive
  ...
  (function () {
    ...
    angular
      .module("umbraco.directives")
      .directive("valRequireComponent", valRequireComponentDirective);
  })();
  ("use strict");
  /**
   * @ngdoc directive
        ...
        if (Utilities.isObject(scope.valServerMatch)) {
          ...
          Object.keys(scope.valServerMatch).forEach(function (matchType) {
            if (allowedKeys.indexOf(matchType) === -1) {
              throw (
                "valServerMatch dictionary keys must be one of " +
                allowedKeys.join()
              );
            }
  ...
  angular
    .module("umbraco.directives.validation")
    .directive("valServerMatch", valServerMatch);
  ("use strict");
  /**
   * @ngdoc directive
  ...
  (function () {
            ...
            if (model) {
              if (!args.form.$valid) {
                ...
                if (subViewContent.length > 0) {
                  model.hasError = true;
                  model.errorClass = args.showValidation
                    ? "show-validation"
                    : null;
                } else {
    ...
    angular
      .module("umbraco.directives")
      .directive("valSubView", valSubViewDirective);
  })();
  ("use strict");
  /**
   * @ngdoc directive
        ...
        valFormManager.onValidationStatusChanged(function (evt, args) {
          if (!args.form.$valid) {
            var tabContent = element
              .closest(".umb-editor")
              .find("[data-element='tab-content-" + tabAlias + "']");
      ...
      return {
        link: function link(scope, elem, attrs) {
          elem.on("click", function () {
            $(attrs.valTriggerChange).trigger(
  ...
  (function () {
    ...
    function BlockCardController($scope, umbRequestHelper) {
      ...
      vm.updateThumbnail = function () {
        if (
          vm.blockConfigModel == null ||
          vm.blockConfigModel.thumbnail == null ||
          vm.blockConfigModel.thumbnail === ""
        ) {
          vm.styleBackgroundImage = "none";
          return;
  ...
  (function () {
    "use strict";
    angular.module("umbraco").component("umbMediaCard", {
      template:
        '<ng-form name="vm.mediaCardForm"> <div class="__showcase"> <div ng-if="vm.loading" class="umb-button__progress"></div> <p ng-if="vm.media.trashed" class="__status --error"> <i class="icon-trash" aria-hidden="true"></i> <localize key="mediaPicker_trashed"></localize> </p> <p ng-if="vm.notAllowed" class="__status --error"> <i class="icon-block" aria-hidden="true"></i> <localize key="mediaPicker_notAllowed"></localize> </p>  <img ng-if="vm.loading === false && vm.thumbnail" ng-class="{\'trashed\': vm.media.trashed}" ng-src="{{vm.thumbnail}}" title="{{vm.media.name}}" alt="{{vm.media.name}}"> <umb-file-icon ng-if="vm.loading === false && vm.icon" icon="{{vm.icon}}" size="s" text="{{vm.name}}"> </umb-file-icon>  <umb-file-icon ng-if="vm.loading === false && !vm.thumbnail" ng-class="{\'trashed\': vm.media.trashed}" title="{{vm.media.name}}" extension="{{vm.media.extension}}" icon="{{vm.media.icon}}" size="s" text="{{vm.media.name}}"> </umb-file-icon> </div> <button type="button" ng-click="vm.onNameClicked($event)" class="btn-reset __info" ng-if="vm.media !== null || vm.name"> <div class="__name" ng-bind="vm.media.name || vm.name"></div> <div class="__subname" ng-if="vm.media.description" ng-bind="vm.media.description"></div> </button> <ng-transclude></ng-transclude> </ng-form> ',
    ...
    function MediaCardController(
      ...
      var unsubscribe = [];
      var vm = this;
      vm.paddingBottom = 100;
      // Square while loading.
      vm.loading = false;
      unsubscribe.push(
        $scope.$watch("vm.mediaKey", function (newValue, oldValue) {
          if (newValue !== oldValue) {
            vm.updateThumbnail();
          }
        })
      ...
      function checkErrorState() {
        vm.notAllowed =
          vm.media &&
          vm.allowedTypes &&
          vm.allowedTypes.length > 0 &&
          vm.allowedTypes.indexOf(vm.media.metaData.ContentTypeAlias) === -1;
        if (
          vm.hasError === true ||
          vm.notAllowed === true ||
          (vm.media && vm.media.trashed === true)
        ) {
      ...
      vm.$onDestroy = function () {
        unsubscribe.forEach(function (x) {
          return x();
        });
      };
      vm.updateThumbnail = function () {
        if (vm.mediaKey && vm.mediaKey !== "") {
          vm.loading = true;
          entityResource.getById(vm.mediaKey, "Media").then(
            function (mediaEntity) {
              vm.media = mediaEntity;
              checkErrorState();
              vm.thumbnail = mediaHelper.resolveFileFromEntity(
                mediaEntity,
                true
              );
              vm.loading = false;
            ...
            function () {
              localizationService
                .localize("mediaPicker_deletedItem")
  ...
  (function () {
    ...
    angular.module("umbraco").component("umbPropertyInfoButton", {
      template:
        '<button type="button" title="{{ vm.show ? \'\' : vm.buttonTitle}}" class="btn-reset umb-outline umb-outline--surrounding __button" ng-click="vm.onMouseClick($event)" ng-bind="vm.symbol"></button> <div class="__tooltip" ng-if="vm.show" on-outside-click="vm.onMouseClickOutside($event)"><ng-transclude></ng-transclude></div> ',
        ...
        if (model.stylesheet) {
          ...
          shadowRoot.innerHTML =
            '\n                    <style>\n                    @import "'
              .concat(
                model.stylesheet,
                '"\n                    </style>\n                    <div class="umb-block-list__block--view" ng-include="\''
              )
              .concat(model.view, "'\"></div>\n                ");
  ...
  (function () {
    ...
    function BlockListController(
      ...
      vm.clipboardItems = [];
      unsubscribe.push(
        eventsService.on("clipboardService.storageUpdate", updateClipboard)
      );
      unsubscribe.push(
        $scope.$on(
          "editors.content.splitViewChanged",
          function (event, eventData) {
            var compositeId = vm.umbVariantContent.editor.compositeId;
            if (
              eventData.editors.some(function (x) {
                return x.compositeId === compositeId;
              })
            ) {
      ...
      vm.labels = {};
      localizationService
        .localizeMany(["grid_addElement", "content_createEmpty"])
        .then(function (data) {
      ...
      vm.$onInit = function () {
        if (vm.umbProperty && !vm.umbVariantContent) {
          ...
          var found = angularHelper.traverseScopeChain($scope, function (s) {
            return (
              s &&
              s.vm &&
              s.vm.constructor.name === "umbVariantContentController"
            );
          });
        ...
        if (
          vm.umbVariantContentEditors &&
          vm.umbVariantContentEditors.getScope
        ) {
          scopeOfExistence = vm.umbVariantContentEditors.getScope();
        } else if (
          vm.umbElementEditorContent &&
          vm.umbElementEditorContent.getScope
        ) {
        ...
        modelObject = blockEditorService.createModelObject(
          vm.model.value,
          vm.model.editor,
      ...
      function onLoaded() {
        ...
        vm.availableContentTypesAliases =
          modelObject.getAvailableAliasesForBlockContent();
      ...
      function getDefaultViewForBlock(block) {
        var defaultViewFolderPath =
          "views/propertyeditors/blocklist/blocklistentryeditors/";
        if (block.config.unsupported === true)
          return (
            defaultViewFolderPath +
            "unsupportedblock/unsupportedblock.editor.html"
          );
      ...
      function deleteBlock(block) {
        ...
        if (layoutIndex === -1) {
          throw new Error(
            "Could not find layout entry of block with udi: " +
              block.layout.contentUdi
          );
        }
        setDirty();
        ...
        removed.forEach(function (x) {
          ...
          guids.forEach(function (guid) {
            if (guid) {
              serverValidationManager.removePropertyError(
                guid,
                vm.umbProperty.property.culture,
                vm.umbProperty.property.segment,
                "",
                { matchType: "contains" }
              );
            }
      ...
      function editBlock(
        ...
        if (
          openSettings !== true &&
          blockObject.hideContentInOverlay === true
        ) {
          return;
        }
        ...
        if (
          openSettings === true &&
          !blockObject.config.settingsElementTypeKey
        ) {
          return;
        }
        ...
        var blockEditorModel = {
          ...
          submit: function submit(blockEditorModel) {
            if (liveEditing === false) {
              ...
              blockObject.retrieveValuesFrom(
                blockEditorModel.content,
                blockEditorModel.settings
              );
            }
      ...
      function requestShowCreate(createIndex, mouseEvent) {
        ...
        if (vm.availableBlockTypes.length === 1) {
          ...
          wasAdded = addNewBlock(
            createIndex,
            blockType.blockConfigModel.contentElementTypeKey
          );
      ...
      function showCreateDialog(createIndex, openClipboard) {
        ...
        var blockPickerModel = {
          ...
          submit: function submit(blockPickerModel, mouseEvent) {
            ...
            if (blockPickerModel && blockPickerModel.selectedItem) {
              wasAdded = addNewBlock(
                createIndex,
                blockPickerModel.selectedItem.blockConfigModel
        ...
        blockPickerModel.clickClearClipboard = function ($event) {
          clipboardService.clearEntriesOfType(
            clipboardService.TYPES.ELEMENT_TYPE,
            vm.availableContentTypesAliases
          );
          clipboardService.clearEntriesOfType(
            clipboardService.TYPES.BLOCK,
            vm.availableContentTypesAliases
          );
        };
      ...
      function updateClipboard(firstTime) {
        ...
        vm.clipboardItems = [];
        var entriesForPaste = clipboardService.retriveEntriesOfType(
          clipboardService.TYPES.ELEMENT_TYPE,
          vm.availableContentTypesAliases
        );
        entriesForPaste.forEach(function (entry) {
          ...
          if (Array.isArray(entry.data) === false) {
            ...
            if (scaffold) {
              pasteEntry.blockConfigModel = modelObject.getBlockConfiguration(
                scaffold.contentTypeKey
              );
            }
          }
        ...
        entriesForPaste.forEach(function (entry) {
          ...
          if (Array.isArray(entry.data) === false) {
            pasteEntry.blockConfigModel = modelObject.getBlockConfiguration(
              entry.data.data.contentTypeKey
            );
          }
          vm.clipboardItems.push(pasteEntry);
        });
        vm.clipboardItems.sort(function (a, b) {
      ...
      function jumpClipboard() {
        ...
        jumpClipboardTimeout = $timeout(function () {
      ...
      function requestCopyAllBlocks() {
        var aliases = [];
        var elementTypesToCopy = vm.layout
        ...
        if (vm.umbVariantContent) {
          ...
          if (vm.umbVariantContentEditors) {
            contentNodeIcon =
              vm.umbVariantContentEditors.content.icon.split(" ")[0];
          } else if (vm.umbElementEditorContent) {
            contentNodeIcon =
              vm.umbElementEditorContent.model.documentType.icon.split(" ")[0];
          }
        } else if (vm.umbElementEditorContent) {
        ...
        localizationService
          .localize("clipboard_labelForArrayOfItemsFrom", [
            vm.model.label,
            contentNodeName,
          ])
          .then(function (localizedLabel) {
            clipboardService.copyArray(
              clipboardService.TYPES.BLOCK,
              aliases,
              elementTypesToCopy,
              localizedLabel,
              contentNodeIcon || "icon-thumbnail-list",
              vm.model.id
            );
          });
      }
      function copyBlock(block) {
        clipboardService.copy(
          clipboardService.TYPES.BLOCK,
          block.content.contentTypeAlias,
          {
            layout: block.layout,
            data: block.data,
      ...
      function onAmountOfBlocksChanged() {
        ...
        if (vm.propertyForm && vm.validationLimit) {
          var isMinRequirementGood =
            vm.validationLimit.min === null ||
            vm.layout.length >= vm.validationLimit.min;
          vm.propertyForm.minCount.$setValidity(
            "minCount",
            isMinRequirementGood
          );
          var isMaxRequirementGood =
            vm.validationLimit.max === null ||
            vm.layout.length <= vm.validationLimit.max;
          vm.propertyForm.maxCount.$setValidity(
            "maxCount",
      ...
      $scope.$on("$destroy", function () {
        ...
        try {
          for (
            var _iterator = unsubscribe[Symbol.iterator](), _step;
  ...
  (function () {
    ...
    function MediaPicker3Controller(
      $scope,
      editorService,
      clipboardService,
      localizationService,
      ...
      vm.$onInit = function () {
        ...
        vm.allowedTypes = vm.model.config.filter
          ? vm.model.config.filter.split(",")
          : null;
        copyAllMediasAction = {
          labelKey: "clipboard_labelForCopyAllEntries",
          labelTokens: [vm.model.label],
        ...
        userService.getCurrentUser().then(function (userData) {
          if (!vm.model.config.startNodeId) {
            if (vm.model.config.ignoreUserStartNodes === true) {
              ...
              vm.model.config.startNodeId =
                userData.startMediaIds.length !== 1
                  ? -1
                  : userData.startMediaIds[0];
              vm.model.config.startNodeIsVirtual =
                userData.startMediaIds.length !== 1;
            }
          }
          // only allow users to add and edit media if they have access to the media section
          var hasAccessToMedia =
            userData.allowedSections.indexOf("media") !== -1;
      ...
      function addMediaAt(createIndex, $event) {
        ...
        mediaPicker.clickClearClipboard = function ($event) {
          clipboardService.clearEntriesOfType(
            clipboardService.TYPES.Media,
            vm.allowedTypes || null
          );
        };
        mediaPicker.clipboardItems = clipboardService.retriveEntriesOfType(
          clipboardService.TYPES.MEDIA,
          vm.allowedTypes || null
        );
        mediaPicker.clipboardItems.sort(function (a, b) {
          return b.date - a.date;
        });
      ...
      function resetCrop(cropEntry) {
        Object.assign(
          cropEntry,
          vm.model.config.crops.find(function (c) {
            return c.alias === cropEntry.alias;
          })
        );
      ...
      function updateMediaEntryData(mediaEntry) {
        ...
        newCrops.forEach(function (crop) {
          var oldCrop = mediaEntry.crops
            .filter(function (x) {
              return x.alias === crop.alias;
            })
            .shift();
          if (
            oldCrop &&
      ...
      function editMedia(mediaEntry, options, $event) {
        ...
        var mediaEditorModel = {
          ...
          enableFocalPointSetter:
            vm.model.config.enableLocalFocalPoint || false,
          view: "views/common/infiniteeditors/mediaEntryEditor/mediaEntryEditor.html",
          size: "large",
          submit: function submit(model) {
            vm.model.value[vm.model.value.indexOf(mediaEntry)] =
              mediaEntryClone;
            setActiveMedia(null);
            editorService.close();
          },
      ...
      var getDocumentNameAndIcon = function getDocumentNameAndIcon() {
        // get node name
        var contentNodeName = "?";
        var contentNodeIcon = null;
        if (vm.umbVariantContent) {
      ...
      var requestCopyAllMedias = function requestCopyAllMedias() {
        var mediaKeys = vm.model.value.map(function (x) {
          return x.mediaKey;
        });
        entityResource.getByIds(mediaKeys, "Media").then(function (entities) {
          // gather aliases
          var aliases = entities.map(function (mediaEntity) {
            return mediaEntity.metaData.ContentTypeAlias;
          });
          // remove duplicate aliases
          aliases = aliases.filter(function (item, index) {
            return aliases.indexOf(item) === index;
          ...
          localizationService
            ...
            .then(function (localizedLabel) {
              clipboardService.copyArray(
                ...
                vm.model.value,
                localizedLabel,
                documentInfo.icon || "icon-thumbnail-list",
                vm.model.id
              );
            });
        });
      ...
      function copyMedia(mediaEntry) {
        entityResource
          .getById(mediaEntry.mediaKey, "Media")
          .then(function (mediaEntity) {
            clipboardService.copy(
              clipboardService.TYPES.MEDIA,
              mediaEntity.metaData.ContentTypeAlias,
              mediaEntry,
              mediaEntity.name,
              mediaEntity.icon,
              mediaEntry.key
      ...
      function requestPasteFromClipboard(createIndex, pasteEntry, pasteType) {
        ...
        pasteEntry = clipboardService.parseContentForPaste(
          pasteEntry,
          pasteType
        );
      ...
      function onAmountOfMediaChanged() {
        ...
        if (vm.propertyForm && vm.validationLimit) {
          var isMinRequirementGood =
            vm.validationLimit.min === null ||
            vm.model.value.length >= vm.validationLimit.min;
          vm.propertyForm.minCount.$setValidity(
            "minCount",
            isMinRequirementGood
          );
          var isMaxRequirementGood =
            vm.validationLimit.max === null ||
            vm.model.value.length <= vm.validationLimit.max;
          vm.propertyForm.maxCount.$setValidity(
            "maxCount",
            isMaxRequirementGood
          );
      ...
      unsubscribe.push(
        $scope.$watch(function () {
          return vm.model.value.length;
        }, onAmountOfMediaChanged)
      );
      $scope.$on("$destroy", function () {
        var _iteratorNormalCompletion = true;
        var _didIteratorError = false;

(function () {
  ...
  (function () {
    ...
    function endPreviewSession() {
      ...
      if (amountOfPreviewSessions <= 0) {
        ...
        navigator.sendBeacon(
          scriptElement.getAttribute("data-umbraco-path") + "/preview/end"
        );
      }
    }
    startPreviewSession();
    ...
    function askToViewPublishedVersion() {
      ...
      request.open(
        "GET",
        scriptElement.getAttribute("data-umbraco-path") + "/LocalizedText"
      );
      request.send();
    ...
    function createAskUserAboutVersionDialog(jsonLocalization) {
      ...
      umbLocalizedVars.preview = Object.assign(
        localizeVarsFallback,
        jsonLocalization.preview
      );
      ...
      continueButton.innerHTML =
        umbLocalizedVars.preview.viewPublishedContentAcceptButton;
      continueButton.addEventListener("click", endPreviewMode);
      modal.appendChild(continueButton);
      var exitButton = document.createElement("button");
      exitButton.type = "button";
      exitButton.innerHTML =
        umbLocalizedVars.preview.viewPublishedContentDeclineButton;
